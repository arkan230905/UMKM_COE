...
echo "PERBAIKAN SISTEMATIS AKUNTANSI MANUFAKTUR" . PHP_EOL;
echo "======================================" . PHP_EOL;

try {
    DB::beginTransaction();
    
    echo PHP_EOL . "1. PERBAIKI JURNAL PELUNASAN HUTANG YANG SALAH..." . PHP_EOL;
    
    // Cari jurnal pelunasan utang yang salah (debit di hutang)
    ...
    foreach ($produksiData as $data) {
        ...
        $journalEntry = $journalService->post(
            ...
            [
                ...
                // Masuk ke WIP (Work in Progress)
                ['code' => '1604', 'debit' => 0, 'credit' => $data['bahan'], 'memo' => 'WIP - Bahan'],
                ['code' => '1604', 'debit' => 0, 'credit' => $data['btkl'], 'memo' => 'WIP - BTKL'],
                ['code' => '1604', 'debit' => 0, 'credit' => $data['bop'], 'memo' => 'WIP - BOP'],
            ]
        );
