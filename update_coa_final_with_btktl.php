...
echo "Mengganti struktur COA dengan struktur final termasuk BTKTL...\n";
...
// Buat COA sesuai struktur final
$coaData = [
    // ASSET
    ...
    // BIAYA OVERHEAD PABRIK (BOP) - Buat dulu BOP accounts
    ...
    // BIAYA TENAGA KERJA TIDAK LANGSUNG (BTKTL) - Buat dulu akun induk
...
// Sekarang update akun 540-546 untuk dual purpose (BOP dan BTKTL)
echo "\nMengupdate akun 540-546 untuk dual purpose BOP dan BTKTL...\n";

$dualPurposeAccounts = [
    ['kode_akun' => '540', 'nama_akun' => 'BOP-Kemasan / BOP BTKTL - Biaya Pegawai Pemasaran', 'kategori_akun' => 'Biaya Overhead Pabrik'],
    ['kode_akun' => '541', 'nama_akun' => 'BOP-Cabe Merah / BOP BTKTL - Biaya Pegawai Kemasan', 'kategori_akun' => 'Biaya Overhead Pabrik'],
    ['kode_akun' => '542', 'nama_akun' => 'BOP-Lada Hitam / BOP BTKTL - Biaya Satpam Pabrik', 'kategori_akun' => 'Biaya Overhead Pabrik'],
    ['kode_akun' => '543', 'nama_akun' => 'BOP BTKTL - Biaya Cleaning Service', 'kategori_akun' => 'Biaya Tenaga Kerja Tidak Langsung'],
    ['kode_akun' => '544', 'nama_akun' => 'BOP BTKTL - Biaya Mandor', 'kategori_akun' => 'Biaya Tenaga Kerja Tidak Langsung'],
    ['kode_akun' => '545', 'nama_akun' => 'BOP BTKTL - Biaya Pegawai Keuangan', 'kategori_akun' => 'Biaya Tenaga Kerja Tidak Langsung'],
    ['kode_akun' => '546', 'nama_akun' => 'BOP BTKTL - BTKTL Lainnya', 'kategori_akun' => 'Biaya Tenaga Kerja Tidak Langsung'],
];

foreach ($dualPurposeAccounts as $account) {
    // Cek apakah akun sudah ada
    $existingAccount = Coa::where('kode_akun', $account['kode_akun'])->first();
    
    if ($existingAccount) {
        // Update nama akun untuk dual purpose
        $existingAccount->update([
            'nama_akun' => $account['nama_akun'],
            'kategori_akun' => $account['kategori_akun']
        ]);
        echo "Updated: " . $account['kode_akun'] . " - " . $account['nama_akun'] . "\n";
    } else {
        // Buat akun baru
        Coa::create([
        ...
        echo "Dibuat: " . $account['kode_akun'] . " - " . $account['nama_akun'] . "\n";
    }
}

echo "\nSelesai! Total COA berhasil dibuat dengan dual purpose accounts untuk BOP dan BTKTL.\n";