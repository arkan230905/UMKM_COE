...
echo "=== CEK FIELD TABEL BOM_JOB_BTKL ===" . PHP_EOL;
...
// Cek satu data yang ada
echo "Mencoba query sederhana..." . PHP_EOL;
$existingData = \Illuminate\Support\Facades\DB::table('bom_job_btkl')->first();
