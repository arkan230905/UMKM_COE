...
echo "Mengganti struktur COA dengan struktur final...\n";
...
$coaData = [
    ...
    // Catatan: Kode 540-546 sudah digunakan di BOP, jadi BTKTL akan menggunakan kode yang sama sesuai permintaan
    // Kita akan membuat akun BTKTL dengan kode berbeda untuk menghindari konflik
...
echo "\nCatatan: BTKTL menggunakan kode yang sama dengan BOP (540-546) sesuai permintaan, tetapi untuk menghindari konflik database, hanya akun induk BTKTL yang dibuat.\n";
echo "Selesai! Total " . count($coaData) . " COA berhasil dibuat.\n";