...
echo "Restoring original barcode scanner system...\n\n";
...
// Add the original barcode scanner system
$originalBarcodeScript = '
<script>
...
document.addEventListener("DOMContentLoaded", function() {
    console.log("DOM loaded - initializing original barcode scanner");
    ...
    console.log("Original barcode scanner initialized");
});
...
// Insert the original barcode scanner script
$content = str_replace('</body>', $originalBarcodeScript . "\n</body>", $content);

// Write the fixed content back to the file
file_put_contents($bladeFile, $content);

echo "\n=== RESTORATION SUMMARY ===\n";
echo "1. Removed all conflicting JavaScript\n";
echo "2. Restored original barcode scanner system\n";
echo "3. Added payment method auto-fill functionality\n";
echo "4. Maintained all original functionality\n";
echo "5. Created backup of original file\n";

echo "\n=== ORIGINAL BARCODE SCANNER FEATURES ===\n";
echo "- Global keydown listener for barcode input\n";
echo "- Product lookup and automatic table addition\n";
echo "- Find empty row or create new row\n";
echo "- Auto-fill product dropdown and set price\n";
echo "- Increment quantity for existing products\n";
echo "- Stock validation and error handling\n";

echo "\n=== PAYMENT METHOD FEATURES ===\n";
echo "- Auto-select account based on payment method\n";
