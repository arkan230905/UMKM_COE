...
echo "=== Update Saldo Awal Menjadi 180 Potong @ Rp 7.500 = Rp 1.350.000 ===\n";
...
$initialStock->qty = 30; // 30 Ekor = 180 Potong
...
$initialStock->save();
echo "Created: Initial stock on 31/01/2026 - 30 Ekor (180 Potong) @ Rp 45,000 = Rp 1,350,000\n";
...
echo "\n=== Data yang Dibuat ===\n";
echo "1. 31/01/2026: Initial stock 30 Ekor (180 Potong) @ Rp 45,000 = Rp 1,350,000\n";
...
echo "\nTotal: 48 Ekor (288 Potong) = Rp 2,310,000\n";
...
echo "Total: 228 Potong @ Rp 8,026.32 = Rp 1,830,000\n";
echo "\nTanggal: 03/02/2026 [Purchase #2]\n";
echo "Stok Awal: 0 Potong @ Rp 0 = Rp 0\n";
echo "Pembelian: 60 Potong @ Rp 8,000 = Rp 480,000\n";
echo "Total: 288 Potong @ Rp 8,020.83 = Rp 2,310,000\n";

echo "\n=== Saldo Awal yang Diminta ===\n";
echo "Tanggal: 01/02/2026\n";
echo "180 Potong @ Rp 7.500,00 = Rp 1.350.000,00\n";
echo "✅ Sesuai dengan permintaan Anda!\n";
