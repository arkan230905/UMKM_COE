...
echo "=== CREATE BIAYA BAHAN DETAIL VIEW ===\n\n";

echo "Creating detail view for biaya bahan...\n";
                        ...
                        <tbody>
                            @foreach($bbbData as $index => $bbb)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <small class="text-muted">{{ $bbb->created_at->format(\'d/m/Y\') }}</small>
                                    </td>
                                    <td class="text-center">
...
$viewFile = 'c:\UMKM_COE\resources\views\master-data\biaya-bahan\detail.blade.php';
file_put_contents($viewFile, $viewContent);

echo "✅ Created detail view at: $viewFile\n";
echo "✅ View includes:\n";
echo "  - Product information\n";
echo "  - Bahan baku details table\n";
echo "  - Total calculations\n";
echo "  - Edit and delete actions\n";
echo "  - Responsive design\n\n";

echo "=== DETAIL VIEW CREATED ===\n";
