...
echo "=== PERBAIKI BOP KETAMPLING ===" . PHP_EOL;
...
try {
    ...
    // Hapus semua data BOP yang ada untuk ketempling
    ...
    // Tambah data BOP yang sama dengan produk lain (Ayam Ketumbar & Opak Geulis)
