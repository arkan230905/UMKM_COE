...
// Step 1: Get all expense payments
echo "STEP 1: Membaca expense_payments...\n";
$result = $conn->query("
...
// Step 2: Delete existing journal_entries for these expense_payments
...
$delete = $conn->query("
    ...
    AND ref_id IN (2, 3)
");
echo "✓ Dihapus: " . $conn->affected_rows . " entries\n\n";

// Step 3: Create new journal_entries
...
if ($created > 0) {
    echo "\n✅ JOURNAL ENTRIES BERHASIL DIBUAT!\n";
