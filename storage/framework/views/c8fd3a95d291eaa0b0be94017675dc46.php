    ...
    <form action="<?php echo e(route('master-data.pegawai.update', $pegawai->id)); ?>" method="POST" id="pegawai-edit-form">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="nama_bank" id="nama_bank" class="form-control" value="<?php echo e(old('nama_bank',$pegawai->nama_bank)); ?>">
            </div>

            <div class="col-md-6 mb-3">
                <label for="no_rekening" class="form-label">No. Rekening</label>
                <input type="text" name="no_rekening" id="no_rekening" class="form-control" value="<?php echo e(old('no_rekening',$pegawai->no_rekening)); ?>">
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\COE_EADT_UMKM_COMPLETE\resources\views/master-data/pegawai/edit.blade.php ENDPATH**/ ?>