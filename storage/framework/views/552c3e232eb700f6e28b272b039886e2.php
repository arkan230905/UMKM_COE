...
<head>
    ...
    <title>Cetak Label Barcode - <?php echo e($produk->nama_produk); ?></title>
...
<body>
    <div class="print-controls">
        ...
        <div class="control-row">
            <div class="control-group">
                <label>Produk</label>
                <strong><?php echo e($produk->nama_produk); ?></strong>
            </div>
            <div class="control-group">
                <label>Barcode</label>
                <strong><?php echo e($produk->barcode); ?></strong>
            </div>
            <div class="control-group">
                <label>Harga Jual</label>
                <strong>Rp <?php echo e(number_format($produk->harga_jual ?? 0, 0, ',', '.')); ?></strong>
            </div>
        </div>
    ...
    <div class="labels-preview">
        <h3>Preview Label (<?php echo e($produk->nama_produk); ?>)</h3>
    ...
    <script>
        const productData = {
            name: "<?php echo e(addslashes($produk->nama_produk)); ?>",
            barcode: "<?php echo e($produk->barcode); ?>",
            price: "Rp <?php echo e(number_format($produk->harga_jual ?? 0, 0, ',', '.')); ?>"
        };
...
<?php /**PATH C:\UMKM_COE\resources\views/master-data/produk/print-barcode.blade.php ENDPATH**/ ?>