                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $penggajians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $gaji): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo e($gaji->total_jam_kerja ?? 0); ?></td>
                            <td>Rp <?php echo e(number_format($gaji->gaji_pokok, 0, ',', '.')); ?></td>
                            <td>Rp <?php echo e(number_format($gaji->tunjangan, 0, ',', '.')); ?></td>
                            <td>Rp <?php echo e(number_format($gaji->potongan, 0, ',', '.')); ?></td>
                            <td><strong>Rp <?php echo e(number_format($gaji->total_gaji, 0, ',', '.')); ?></strong></td>
                            <td>
                                <form action="<?php echo e(route('transaksi.penggajian.destroy', $gaji->id)); ?>" method="POST" onsubmit="return confirm('Hapus data ini?')">
                                    <?php echo csrf_field(); ?>
