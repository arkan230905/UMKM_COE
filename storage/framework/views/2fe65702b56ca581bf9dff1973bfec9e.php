        ...
        <div class="card shadow-sm mb-3">
            <div class="card-header text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <h6 class="mb-0">
                    ...
                    <small>(<?php echo e(count($bomJobBBB)); ?> item)</small>
                </h6>
            </div>
            <div class="card-body" style="background-color: #f8f4ff;">
                <div class="table-responsive">
                    <table class="table table-sm" id="bahanBakuTable">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bomJobBBB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                    ...
                                    <td class="text-end harga-display" style="width: 200px;">
                                        <div class="harga-utama">Rp <?php echo e(number_format($detail->harga_satuan, 0, ',', '.')); ?></div>
                                        <div class="harga-konversi mt-1" style="font-size: 0.75rem; color: #666;"></div>
                                    </td>
                                    <td class="text-end subtotal-display" style="width: 150px;">
                                        <strong>Rp <?php echo e(number_format($detail->subtotal, 0, ',', '.')); ?></strong>
                                    </td>
