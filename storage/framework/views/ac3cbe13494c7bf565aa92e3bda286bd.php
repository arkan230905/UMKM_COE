<?php $__env->startSection('title', 'Hitung Harga Pokok Produksi'); ?>
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('master-data.harga-pokok-produksi.index')); ?>" class="btn btn-outline-secondary">
    ...
    <form action="<?php echo e(route('master-data.harga-pokok-produksi.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="row">
            <!-- Product Selection -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="produk_id" name="produk_id" required>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Models\Produk::where('user_id', auth()->id())->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div id="btkl-container" class="row">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prosesProduksi->isEmpty()): ?>
                                <div class="col-12 text-center text-muted py-3">
                                    <i class="fas fa-info-circle me-2"></i>Belum ada data BTKL tersedia
                                </div>
                            <?php else: ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $prosesProduksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                            ...
                                            <div class="card-body p-3">
                                                <div class="form-check mb-0">
                                                    <input class="form-check-input btkl-checkbox" type="checkbox" 
                                                           name="selected_btkl[]" value="<?php echo e($item->id); ?>" id="btkl_<?php echo e($item->id); ?>"
                                                           data-tarif="<?php echo e($biayaPerProduk); ?>"
                                                           style="transform: scale(1.2); margin-top: 8px;">
                                                    <label class="form-check-label w-100" for="btkl_<?php echo e($item->id); ?>">
                                                        <div class="row align-items-center">
                                                            <div class="col-md-4">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="mb-0 text-warning fw-bold"><?php echo e($item->nama_proses); ?></h6>
                                                                        <small class="text-muted"><?php echo e($item->kode_proses ?? '-'); ?></small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 text-center">
                                                                <small class="text-muted d-block">Tarif/Jam</small>
                                                                <strong class="text-dark">Rp <?php echo e(number_format($tarif, 0, ',', '.')); ?></strong>
                                                            </div>
                                                            <div class="col-md-2 text-center">
                                                                <small class="text-muted d-block">Kapasitas</small>
                                                                <strong class="text-dark"><?php echo e($kapasitas); ?> <?php echo e($item->satuan_btkl ?? 'Unit'); ?>/jam</strong>
                                                            </div>
                                                            <div class="col-md-3 text-center">
                                                                <div class="bg-warning bg-opacity-10 rounded p-2">
                                                                    <small class="text-muted d-block">Biaya/Produk</small>
                                                                    <h5 class="mb-0 fw-bold text-warning">Rp <?php echo e(number_format($biayaPerProduk, 0, ',', '.')); ?></h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </label>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div id="bop-container" class="row">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bopProses->isEmpty()): ?>
                                <div class="col-12 text-center text-muted py-3">
                                    <i class="fas fa-info-circle me-2"></i>Belum ada data BOP tersedia
                                </div>
                            <?php else: ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bopProses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                            ...
                                            <div class="card-body p-3">
                                                <div class="form-check mb-0">
                                                    <input class="form-check-input bop-checkbox" type="checkbox" 
                                                           name="selected_bop[]" value="<?php echo e($item->id); ?>" id="bop_<?php echo e($item->id); ?>"
                                                           data-tarif="<?php echo e($totalBop); ?>"
                                                           style="transform: scale(1.2); margin-top: 8px;">
                                                    <label class="form-check-label w-100" for="bop_<?php echo e($item->id); ?>">
                                                        <div class="row align-items-center">
                                                            <div class="col-md-4">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="mb-0 fw-bold" style="color: #a0826d;"><?php echo e($item->nama_bop_proses ?? 'BOP Proses'); ?></h6>
                                                                        <small class="text-muted"><?php echo e(is_array($komponenBop) ? count($komponenBop) : 0); ?> komponen</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5 text-center">
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($komponenBop) && count($komponenBop) > 0): ?>
                                                                    <div class="row g-1">
                                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $komponenBop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $komp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <div class="col-6">
                                                                                <div class="d-flex justify-content-between align-items-center p-1 rounded" style="background-color: rgba(160, 130, 109, 0.05); font-size: 0.8rem;">
                                                                                    <small class="text-muted text-truncate me-1"><?php echo e($komp['component'] ?? 'N/A'); ?></small>
                                                                                    <strong class="text-dark text-nowrap">Rp <?php echo e(number_format($komp['rate_per_hour'] ?? 0, 0, ',', '.')); ?></strong>
                                                                                </div>
                                                                            </div>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-3 text-center">
                                                                <div class="rounded p-2" style="background-color: rgba(160, 130, 109, 0.1);">
                                                                    ...
                                                                    <h5 class="mb-0 fw-bold" style="color: #a0826d;">Rp <?php echo e(number_format($totalBop, 0, ',', '.')); ?></h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/master-data/bom/create.blade.php ENDPATH**/ ?>