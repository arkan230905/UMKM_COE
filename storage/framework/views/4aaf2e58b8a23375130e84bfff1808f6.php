<?php $__env->startSection('title', 'Edit COA'); ?>
...
<div class="container mt-4">
    ...
    <form action="<?php echo e(route('master-data.coa.update',$coa->id)); ?>" method="POST" id="coaForm">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-8">
                ...
                <select name="parent_coa_id" id="parent_coa_id" class="form-select">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $parentCoas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($p->id); ?>"
                            data-kode="<?php echo e($p->kode_akun); ?>"
                            data-tipe="<?php echo e($p->tipe_akun); ?>"
                            data-kategori="<?php echo e($p->kategori_akun); ?>"
                            data-saldo-normal="<?php echo e($p->saldo_normal); ?>">
                            <?php echo e(str_repeat('—', strlen($p->kode_akun) - 1)); ?> <?php echo e($p->kode_akun); ?> - <?php echo e($p->nama_akun); ?> (<?php echo e($p->tipe_akun); ?>)
                        </option>
            ...
            <div class="col-md-4">
                ...
                <select name="tipe_akun" id="tipe_akun" class="form-select" required>
                    ...
                    <option value="Asset" <?php echo e(old('tipe_akun', $coa->tipe_akun)==='Asset'?'selected':''); ?>>Aset</option>
                    <option value="Liability" <?php echo e(old('tipe_akun', $coa->tipe_akun)==='Liability'?'selected':''); ?>>Kewajiban</option>
                    <option value="Equity" <?php echo e(old('tipe_akun', $coa->tipe_akun)==='Equity'?'selected':''); ?>>Modal</option>
                    <option value="Revenue" <?php echo e(old('tipe_akun', $coa->tipe_akun)==='Revenue'?'selected':''); ?>>Pendapatan</option>
                    <option value="Expense" <?php echo e(old('tipe_akun', $coa->tipe_akun)==='Expense'?'selected':''); ?>>Beban</option>
                </select>
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="kode_akun" id="kode_akun" class="form-control" value="<?php echo e(old('kode_akun', $coa->kode_akun)); ?>" required>
            </div>
            ...
            <div class="col-md-4">
                ...
                <select name="saldo_normal" id="saldo_normal" class="form-select">
                    <option value="">-</option>
                    <option value="debit" <?php echo e(old('saldo_normal', $coa->saldo_normal)==='debit'?'selected':''); ?>>Debit</option>
                    <option value="kredit" <?php echo e(old('saldo_normal', $coa->saldo_normal)==='kredit'?'selected':''); ?>>Kredit</option>
                </select>
            </div>
            ...
            <div class="col-md-12">
                ...
                <input type="text" name="nama_akun" class="form-control" value="<?php echo e(old('nama_akun', $coa->nama_akun)); ?>" required>
            </div>
            ...
            <div class="col-md-3">
                ...
                <input type="date" name="tanggal_saldo_awal" class="form-control" value="<?php echo e(old('tanggal_saldo_awal', $coa->tanggal_saldo_awal)); ?>">
            </div>
            ...
            <div class="col-md-12">
                ...
                <textarea name="keterangan" class="form-control" rows="2"><?php echo e(old('keterangan', $coa->keterangan)); ?></textarea>
            </div>
        </div>
...
function generateChildKode() {
    ...
    fetch(`<?php echo e(url('/master-data/coa/generate-child-kode')); ?>?parent_coa_id=${parentId}`)
        .then(res => res.json())
        .then(data => {
            if (data.error) {
                alert(data.error);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/master-data/coa/edit.blade.php ENDPATH**/ ?>