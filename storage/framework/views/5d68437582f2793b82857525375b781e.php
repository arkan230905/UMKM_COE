...
<div class="container-fluid px-4 py-4">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allDetails && count($allDetails) > 0): ?>
                <!-- Bahan Baku Section -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <small class="text-muted"><?php echo e($bahan['satuan']); ?></small>
                                                </div>
                                            </td>
