<?php $__env->startSection('title', 'Tambah Vendor'); ?>
...
<div class="container">
    ...
    <form action="<?php echo e(route('master-data.vendor.store')); ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="no_telp" class="form-control" value="<?php echo e(old('no_telp')); ?>" required>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/master-data/vendor/create.blade.php ENDPATH**/ ?>