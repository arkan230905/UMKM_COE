...
<body>
    ...
    <div class="logo-external">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="UMKM Logo" class="logo-external-main">
        <div class="logo-external-partners">
            <img src="<?php echo e(asset('images/logo_telkom.png')); ?>" alt="Telkom Logo" class="logo-external-partner" title="Supported by Telkom">
            <img src="<?php echo e(asset('images/logo_eadt.png')); ?>" alt="EADT Logo" class="logo-external-partner" title="Powered by EADT">
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div id="login-fields" style="display: none;">
                    ...
                    <div id="kode_perusahaan_field" class="mb-3" style="display: none;">
                        ...
                        <input id="kode_perusahaan" type="text" name="kode_perusahaan" value="<?php echo e(old('kode_perusahaan')); ?>" class="form-control" placeholder="Masukkan kode perusahaan">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div id="email_field" class="mb-3" style="display: none;">
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control" placeholder="Masukkan email Anda">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="text-center mt-3" style="margin-top: 0.75rem !important;">
                        ...
                        <a href="<?php echo e(route('register')); ?>" style="color: #3e2723; font-weight: bold; font-size: 0.65rem;">Daftar sekarang</a>
                    </div>
                </div>
            </form>
        </div>
...
<?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/auth/login.blade.php ENDPATH**/ ?>