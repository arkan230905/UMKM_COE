<?php $__env->startSection('title', 'Edit Perhitungan Biaya Bahan Baku'); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-sm" id="bahanBakuTable">
                        ...
                        <tbody>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $biayaBahanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <select name="bahan_baku[<?php echo e($index); ?>][id]" class="form-select form-select-sm bahan-baku-select">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bahanBakus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bahanBaku): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <option value="<?php echo e($bahanBaku->id); ?>" 
                                                        data-harga="<?php echo e($bahanBaku->harga_rata_rata ?? $bahanBaku->harga_satuan); ?>"
                                                    ...
                                                    <?php echo e($bahanBaku->nama_bahan); ?> - Rp <?php echo e(number_format($bahanBaku->harga_rata_rata ?? $bahanBaku->harga_satuan, 0, ',', '.')); ?>/<?php echo e($satuanBB); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/master-data/biaya-bahan/edit.blade.php ENDPATH**/ ?>