...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('harga_satuan', 0)); ?>" min="0" step="100" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('stok', 0)); ?>" min="0" step="0.01">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('stok_minimum', 0)); ?>" min="0" step="0.01">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="3" placeholder="Deskripsi bahan pendukung (opsional)"><?php echo e(old('deskripsi')); ?></textarea>
                </div>

                <hr>
                <div class="d-flex justify-content-end gap-2">
                    <a href="<?php echo e(route('master-data.bahan-pendukung.index')); ?>" class="btn btn-secondary">Batal</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\UMKM_COE\resources\views/master-data/bahan-pendukung/create.blade.php ENDPATH**/ ?>