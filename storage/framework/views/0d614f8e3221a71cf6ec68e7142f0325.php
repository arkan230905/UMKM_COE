<?php $__env->startSection('title', 'Daftar BOP'); ?>
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo e(route('master-data.beban-operasional.index')); ?>" class="btn btn-outline-primary me-2">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0 table-wide">
                        ...
                        <tbody>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $bopProses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <div class="fw-semibold"><?php echo e($bop->nama_bop_proses ?? ($bop->prosesProduksi ? $bop->prosesProduksi->nama_proses : '-')); ?></div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <div class="fw-semibold text-warning">Rp <?php echo e(formatNumberClean($bop->total_bop_per_produk ?? $bop->bop_per_unit)); ?></div>
                                ...
                                <td>
                                    <div class="small">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($komponenBop)): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $komponenBop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $komponen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="d-flex justify-content-between align-items-center py-1">
                                                    <span class="text-muted"><?php echo e($komponen['component'] ?? 'N/A'); ?></span>
                                                    <span class="fw-semibold">Rp <?php echo e(formatNumberClean($komponen['rate_per_produk'] ?? $komponen['rate_per_hour'] ?? 0)); ?></span>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div class="border-top pt-1 mt-1">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <strong>Total BOP / produk:</strong>
                                                    <strong class="text-primary">Rp <?php echo e(formatNumberClean($bop->total_bop_per_produk ?? $bop->bop_per_unit)); ?></strong>
                                                </div>
                                            </div>
                                        <?php else: ?>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <button type="button" 
                                               ...
                                               onclick="editBopProses(<?php echo e($bop->id); ?>)"
                                        ...
                                        <button type="button" 
                                               ...
                                               data-bs-target="#deleteModal<?php echo e($bop->id); ?>"
                                               data-bs-toggle="tooltip" 
                                               title="Hapus BOP">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bopProses->count() > 0): ?>
                            <tr class="table-active fw-bold">
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-end">
                                        ...
                                        ?>
                                        <span class="fw-bold text-success fs-6">Rp <?php echo e(formatNumberClean($totalBopPerProduk)); ?></span>
                                    </div>
                                </td>
                            </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<!-- Delete Modals -->
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $bopProses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
<div class="modal fade" id="deleteModal<?php echo e($bop->id); ?>" tabindex="-1" aria-labelledby="deleteModalLabel<?php echo e($bop->id); ?>" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title" id="deleteModalLabel<?php echo e($bop->id); ?>">
            ...
            <div class="modal-body">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted mb-0">Data BOP untuk proses <strong>"<?php echo e($bop->nama_bop_proses ?? ($bop->prosesProduksi ? $bop->prosesProduksi->nama_proses : 'Tidak Diketahui')); ?>"</strong> akan dihapus secara permanen.</p>
                </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <ul class="mb-0 mt-1 small">
                                <li>Proses: <?php echo e($bop->nama_bop_proses ?? ($bop->prosesProduksi ? $bop->prosesProduksi->nama_proses : 'Tidak Diketahui')); ?></li>
                                <li>BOP / produk: Rp <?php echo e(formatNumberClean($bop->bop_per_unit)); ?></li>
                                                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <form action="<?php echo e(route('master-data.bop.destroy-proses', $bop->id)); ?>" method="POST" class="d-inline">
                    <?php echo csrf_field(); ?>
...
<!-- Modals -->
<?php echo $__env->make('master-data.bop.modals', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->startPush('scripts'); ?>
<script>
// Store BTKL data for auto-fill functionality
const btklData = <?php echo json_encode($btklData, 15, 512) ?>;
    ...
    newRow.innerHTML = `
        ...
        <td>
            <select name="komponen_coa_debit[]" class="form-select form-select-sm" required>
                ...
                <?php $__currentLoopData = \App\Models\Coa::withoutGlobalScopes()->where('user_id', auth()->id())->where('kode_akun', 'LIKE', '117%')->orderBy('kode_akun')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <td>
            <select name="komponen_coa_kredit[]" class="form-select form-select-sm" required>
                ...
                <optgroup label="Hutang">
                    <?php $__currentLoopData = \App\Models\Coa::withoutGlobalScopes()->where('user_id', auth()->id())->where('kode_akun', 'LIKE', '21%')->orderBy('kode_akun')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <optgroup label="Persediaan">
                    <?php $__currentLoopData = \App\Models\Coa::withoutGlobalScopes()->where('user_id', auth()->id())->where('kode_akun', 'LIKE', '115%')->orderBy('kode_akun')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        row.innerHTML = `
            ...
            <td>
                <select name="komponen_coa_debit[]" class="form-select form-select-sm" required>
                    <option value="">-- Pilih --</option>
                    <?php $__currentLoopData = \App\Models\Coa::withoutGlobalScopes()->where('user_id', auth()->id())->where('kode_akun', 'LIKE', '117%')->orderBy('kode_akun')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($coa->kode_akun); ?>" ${(comp.coa_debit || '1173') === '<?php echo e($coa->kode_akun); ?>' ? 'selected' : ''}>
                            <?php echo e($coa->kode_akun); ?> - <?php echo e($coa->nama_akun); ?>
            ...
            <td>
                <select name="komponen_coa_kredit[]" class="form-select form-select-sm" required>
                    ...
                    <optgroup label="Hutang">
                        <?php $__currentLoopData = \App\Models\Coa::withoutGlobalScopes()->where('user_id', auth()->id())->where('kode_akun', 'LIKE', '21%')->orderBy('kode_akun')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($coa->kode_akun); ?>" ${(comp.coa_kredit || '210') === '<?php echo e($coa->kode_akun); ?>' ? 'selected' : ''}>
                                <?php echo e($coa->kode_akun); ?> - <?php echo e($coa->nama_akun); ?>
                    ...
                    <optgroup label="Persediaan">
                        <?php $__currentLoopData = \App\Models\Coa::withoutGlobalScopes()->where('user_id', auth()->id())->where('kode_akun', 'LIKE', '115%')->orderBy('kode_akun')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($coa->kode_akun); ?>" ${(comp.coa_kredit || '') === '<?php echo e($coa->kode_akun); ?>' ? 'selected' : ''}>
                                <?php echo e($coa->kode_akun); ?> - <?php echo e($coa->nama_akun); ?>
...
function editBebanOperasional(id) {
    fetch(`<?php echo e(route('master-data.bop.beban-operasional.get', ':id')); ?>`.replace(':id', id))
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function deleteBebanOperasional(id) {
    if (confirm('Apakah Anda yakin ingin menghapus Beban Operasional ini?')) {
        fetch(`<?php echo e(route('master-data.bop.beban-operasional.delete', ':id')); ?>`.replace(':id', id), {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
...
function saveBebanOperasional() {
    ...
    fetch('<?php echo e(route('master-data.bop.beban-operasional.store')); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
...
function updateBebanOperasional() {
    ...
    fetch(`<?php echo e(route('master-data.bop.beban-operasional.update', ':id')); ?>`.replace(':id', id), {
