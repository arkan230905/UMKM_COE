...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedProduk): ?>
                Buat BOM: <?php echo e($selectedProduk->nama_produk); ?>
    ...
    <form action="<?php echo e(route('master-data.bom.store')); ?>" method="POST" id="bomForm">
        <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedProduk): ?>
                            ...
                            <input type="hidden" name="produk_id" value="<?php echo e($selectedProduk->id); ?>">
                            <div class="form-control-plaintext bg-light p-3 rounded border">
                                <div class="d-flex align-items-center">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedProduk->foto): ?>
                                        <img src="<?php echo e(Storage::url($selectedProduk->foto)); ?>" 
                                             alt="<?php echo e($selectedProduk->nama_produk); ?>" 
                                             class="rounded me-3"
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div>
                                        <div class="fw-bold fs-5"><?php echo e($selectedProduk->nama_produk); ?></div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedProduk->barcode): ?>
                                            <small class="text-muted"><?php echo e($selectedProduk->barcode); ?></small>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                            </div>
