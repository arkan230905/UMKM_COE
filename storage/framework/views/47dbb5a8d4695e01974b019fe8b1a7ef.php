                            ...
                            <tr class="bom-row">
                                <td>
                                    <select name="bahan_baku_id[]" class="form-select form-select-sm bahan-select" required>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bahanBakus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bahan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($bahan->id); ?>" 
                                                data-harga="<?php echo e($bahan->harga_satuan ?? 0); ?>" 
                                                data-satuan="<?php echo e(is_object($bahan->satuan) ? $bahan->satuan->kode : ($bahan->satuan ?? 'KG')); ?>"
                                                data-nama="<?php echo e($bahan->nama_bahan ?? $bahan->nama); ?>">
                                                <?php echo e($bahan->nama_bahan ?? $bahan->nama); ?>
                                ...
                                <td>
                                    <select name="satuan[]" class="form-select form-select-sm satuan-select" required>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($satuan->kode); ?>"><?php echo e($satuan->kode); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
                                </td>
...
<script>
// Data dari backend
const bahanBakuData = <?php echo json_encode($bahanBakus, 15, 512) ?>;
