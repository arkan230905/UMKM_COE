            ...
            <div class="row g-3 align-items-center">
                <div class="col-md-4">
                    <form method="GET" action="<?php echo e(route('master-data.pegawai.index')); ?>" class="input-group">
                        <input type="text" name="search" class="form-control" placeholder="Cari pegawai..." value="<?php echo e(request('search')); ?>">
                ...
                <table class="table table-hover align-middle mb-0 table-wide">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-alamat"><small class="text-muted"><?php echo e(Str::limit($pegawai->alamat, 60)); ?></small></td>
                            <td><?php echo e($pegawai->nama_bank); ?></td>
                            <td><?php echo e($pegawai->no_rekening); ?></td>
                            <td><?php echo e($pegawai->jabatan); ?></td>
                            <td class="text-center">
                                <span class="badge bg-<?php echo e(strtolower($pegawai->kategori) == 'btkl' ? 'primary' : 'success'); ?>"><?php echo e(strtoupper($pegawai->kategori)); ?></span>
                            </td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\COE_EADT_UMKM_COMPLETE\resources\views/master-data/pegawai/index.blade.php ENDPATH**/ ?>