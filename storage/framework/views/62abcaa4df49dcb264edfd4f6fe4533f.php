    ...
    <form action="<?php echo e(route('transaksi.penjualan.store')); ?>" method="POST" id="form-penjualan">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-3">
                ...
                <input type="time" name="waktu" class="form-control" value="<?php echo e(now()->format('H:i')); ?>" required>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3" id="sumber_dana_wrapper_jual">
                ...
                <select name="sumber_dana" id="sumber_dana_jual" class="form-select">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kasbank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <option value="<?php echo e($kb->kode_akun); ?>" data-tipe="<?php echo e($tipe); ?>">
                                ...
                                <optgroup label="Produk Individual">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($p->id); ?>" 
                                                ...
                                                data-stok="<?php echo e($p->stok ?? 0); ?>"
                                                data-type="produk"
                                                data-nama="<?php echo e($p->nama_produk ?? $p->nama); ?>">
                                            <?php echo e($p->nama_produk ?? $p->nama); ?> (Stok: <?php echo e(number_format($p->stok ?? 0, 0, ',', '.')); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </optgroup>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paketMenus->count() > 0): ?>
                                <optgroup label="Paket Menu">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $paketMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="paket_<?php echo e($paket->id); ?>" 
                                                data-price="<?php echo e(round($paket->harga_paket ?? 0)); ?>"
                                                data-stok="999"
                                                data-type="paket"
                                                data-paket-id="<?php echo e($paket->id); ?>"
                                                data-paket-details="<?php echo e(json_encode($paket->details->map(function($d) { return ['produk_id' => $d->produk_id, 'jumlah' => $d->jumlah, 'nama_produk' => $d->produk->nama_produk ?? $d->produk->nama]; }))); ?>">
                ...
                <div class="d-flex justify-content-between align-items-center py-2">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <select name="biaya_ongkir" id="biaya_ongkir"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ongkirSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ongkir): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e((int)$ongkir->harga_ongkir); ?>">
                                    <?php echo e($ongkir->getJarakLabel()); ?> - Rp <?php echo e(number_format($ongkir->harga_ongkir, 0, ',', '.')); ?>
        ...
        <div id="jurnal-validation-alert" class="alert alert-warning d-none mt-3" role="alert">
            <div class="d-flex align-items-start gap-2">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-2">
                        <a href="<?php echo e(route('master-data.coa.create')); ?>" target="_blank" class="btn btn-warning btn-sm">
...
if (total <= 0) {
        ...
        console.log('Sending AJAX request to:', '<?php echo e(route("transaksi.penjualan.prepare-payment")); ?>');
        
        // Store in session and redirect to payment page
        fetch('<?php echo e(route("transaksi.penjualan.prepare-payment")); ?>', {
            method: 'POST',
            headers: {
...
const productData = {
    ...
    <?php if($p->barcode): ?>
    '<?php echo e(trim($p->barcode)); ?>': {
        id: <?php echo e($p->id); ?>,
        nama: '<?php echo e(addslashes($p->nama_produk ?? $p->nama)); ?>',
        harga: <?php echo e(round($p->harga_jual ?? 0)); ?>,
        stok: <?php echo e($p->stok ?? 0); ?>,
        barcode: '<?php echo e(trim($p->barcode)); ?>'
    },
    <?php endif; ?>
...
const searchableProducts = [
    <?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    {
        ...
        harga: <?php echo e(round($p->harga_jual ?? 0)); ?>,
        stok: <?php echo e($p->stok ?? 0); ?>,
        barcode: '<?php echo e($p->barcode ?? ''); ?>',
        type: 'produk',
        searchText: '<?php echo e(strtolower(addslashes($p->nama_produk ?? $p->nama))); ?> <?php echo e($p->barcode ?? ''); ?>'.toLowerCase()
    },
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php $__currentLoopData = $paketMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    {
        id: 'paket_<?php echo e($paket->id); ?>',
        nama: '<?php echo e(addslashes($paket->nama_paket)); ?>',
        harga: <?php echo e(round($paket->harga_paket ?? 0)); ?>,
        stok: 999,
        barcode: '',
        type: 'paket',
        paket_id: <?php echo e($paket->id); ?>,
        paket_details: <?php echo json_encode($paket->details->map(function($d) { return ['produk_id' => $d->produk_id, 'jumlah' => $d->jumlah, 'nama_produk' => $d->produk->nama_produk ?? $d->produk->nama]; })); ?>,
        searchText: '<?php echo e(strtolower(addslashes($paket->nama_paket))); ?> paket menu'.toLowerCase()
    },
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
];
...
(function() {
    ...
    function runJurnalValidation() {
        ...
        fetch('<?php echo e(route("api-internal.penjualan.validate-jurnal")); ?>', {
            method: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/transaksi/penjualan/create.blade.php ENDPATH**/ ?>