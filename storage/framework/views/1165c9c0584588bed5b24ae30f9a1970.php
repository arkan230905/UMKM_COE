...
<div class="container mt-4">
    ...
    <form action="<?php echo e(route('master-data.pegawai.update', $pegawai->id)); ?>" method="POST" id="pegawai-edit-form">
        <?php echo csrf_field(); ?>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="nama" id="nama" class="form-control" value="<?php echo e(old('nama',$pegawai->nama)); ?>" required>
            </div>

            <div class="col-md-6 mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" name="email" id="email" class="form-control" value="<?php echo e(old('email',$pegawai->email)); ?>" required>
            </div>

            <div class="col-md-6 mb-3">
                <label for="no_telepon" class="form-label">No. Telepon</label>
                <input type="text" name="no_telepon" id="no_telepon" class="form-control" value="<?php echo e(old('no_telepon',$pegawai->no_telepon)); ?>" required>
            </div>

            <div class="col-md-6 mb-3">
                <label for="alamat" class="form-label">Alamat</label>
                <textarea name="alamat" id="alamat" class="form-control" rows="2" required><?php echo e(old('alamat',$pegawai->alamat)); ?></textarea>
            </div>

            <div class="col-md-6 mb-3">
                <label class="form-label">Jenis Kelamin</label>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="laki_laki" value="L" <?php echo e(old('jenis_kelamin', $pegawai->jenis_kelamin) == 'L' ? 'checked' : ''); ?> required>
                    <label class="form-check-label" for="laki_laki">Laki-laki</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="perempuan" value="P" <?php echo e(old('jenis_kelamin', $pegawai->jenis_kelamin) == 'P' ? 'checked' : ''); ?> required>
                ...
                <select name="jabatan_id" id="jabatan_id" class="form-select" required>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $jabatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($j->id); ?>"
                                ...
                                <?php echo e(old('jabatan_id')==$j->id || $pegawai->jabatan===$j->nama ? 'selected' : ''); ?>>
            ...
            <input type="hidden" name="jabatan" id="jabatan" value="<?php echo e(old('jabatan',$pegawai->jabatan)); ?>">
            <input type="hidden" name="kategori" id="kategori" value="<?php echo e(old('kategori',$pegawai->kategori)); ?>">
            <input type="hidden" name="tunjangan" id="tunjangan" value="<?php echo e(old('tunjangan',$pegawai->tunjangan)); ?>">
            <input type="hidden" name="asuransi" id="asuransi" value="<?php echo e(old('asuransi',$pegawai->asuransi)); ?>">
            <input type="hidden" name="gaji" id="gaji" value="<?php echo e(old('gaji',$pegawai->gaji)); ?>">
            <input type="hidden" name="tarif" id="tarif" value="<?php echo e(old('tarif',$pegawai->tarif)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('bank', $pegawai->bank)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nomor_rekening', $pegawai->nomor_rekening)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nama_rekening', $pegawai->nama_rekening)); ?>" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="mt-3">
            ...
            <a href="<?php echo e(route('master-data.pegawai.index')); ?>" class="btn btn-secondary">Batal</a>
        </div>
    </form>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\UMKM_COE\resources\views/master-data/pegawai/edit.blade.php ENDPATH**/ ?>