...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="<?php echo e(route('master-data.bahan-baku.update', $bahanBaku->id)); ?>" method="POST" novalidate>
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($bahanBaku->kode_bahan ?? 'Auto Generate'); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('nama_bahan', $bahanBaku->nama_bahan)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($satuan->id); ?>" <?php echo e($bahanBaku->satuan_id == $satuan->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('harga_satuan', $bahanBaku->harga_satuan)); ?>" placeholder="0" required>
                                <input type="hidden" name="harga_satuan_raw" id="harga_satuan_raw" value="<?php echo e($bahanBaku->harga_satuan); ?>">
                            </div>
                            <div class="mt-2">
                                <small class="text-muted">
                                    Harga Rata-Rata: Rp <?php echo e(number_format($bahanBaku->harga_rata_rata, 2, ',', '.')); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('stok', rtrim(rtrim(number_format($bahanBaku->saldo_awal, 4, '.', ''), '0'), '.'))); ?>" min="0" step="any">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="stok_minimum" id="stok_minimum" class="form-control price-input <?php $__errorArgs = ['stok_minimum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('stok_minimum', $bahanBaku->stok_minimum ?? 0)); ?>" placeholder="0">
                            <input type="hidden" name="stok_minimum_raw" id="stok_minimum_raw" value="<?php echo e($bahanBaku->stok_minimum ?? 0); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" 
                                       value="<?php echo e(number_format($bahanBaku->harga_rata_rata ?? 0, 0, ',', '.')); ?>" readonly>
                            </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="3" placeholder="Deskripsi bahan baku (opsional)"><?php echo e(old('deskripsi', $bahanBaku->deskripsi ?? '')); ?></textarea>
                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('sub_satuan_1_konversi', $bahanBaku->sub_satuan_1_konversi ? rtrim(rtrim(number_format($bahanBaku->sub_satuan_1_konversi, 4, ',', ''), '0'), ',') : '1')); ?>" placeholder="1" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control satuan-utama-text" value="<?php echo e($bahanBaku->satuan->nama ?? 'Pilih Satuan Utama'); ?>" readonly style="background-color: #f8f9fa;">
                            </div>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('sub_satuan_1_nilai', $bahanBaku->sub_satuan_1_nilai ? rtrim(rtrim(number_format($bahanBaku->sub_satuan_1_nilai, 4, ',', ''), '0'), ',') : '1')); ?>" placeholder="1" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($satuan->id); ?>" <?php echo e(old('sub_satuan_1_id', $bahanBaku->sub_satuan_1_id) == $satuan->id ? 'selected' : ''); ?>>
                                            <?php echo e($satuan->nama); ?> (<?php echo e($satuan->kode); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('sub_satuan_2_konversi', $bahanBaku->sub_satuan_2_konversi ? rtrim(rtrim(number_format($bahanBaku->sub_satuan_2_konversi, 4, ',', ''), '0'), ',') : '1')); ?>" placeholder="1">
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('sub_satuan_2_nilai', $bahanBaku->sub_satuan_2_nilai ? rtrim(rtrim(number_format($bahanBaku->sub_satuan_2_nilai, 4, ',', ''), '0'), ',') : '1')); ?>" placeholder="1">
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="">- Pilih Satuan -</option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($satuan->id); ?>" <?php echo e(old('sub_satuan_2_id', $bahanBaku->sub_satuan_2_id) == $satuan->id ? 'selected' : ''); ?>>
                                            <?php echo e($satuan->nama); ?> (<?php echo e($satuan->kode); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('sub_satuan_3_konversi', $bahanBaku->sub_satuan_3_konversi ? rtrim(rtrim(number_format($bahanBaku->sub_satuan_3_konversi, 4, ',', ''), '0'), ',') : '1')); ?>" placeholder="1">
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('sub_satuan_3_nilai', $bahanBaku->sub_satuan_3_nilai ? rtrim(rtrim(number_format($bahanBaku->sub_satuan_3_nilai, 4, ',', ''), '0'), ',') : '1')); ?>" placeholder="1">
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="">- Pilih Satuan -</option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($satuan->id); ?>" <?php echo e(old('sub_satuan_3_id', $bahanBaku->sub_satuan_3_id) == $satuan->id ? 'selected' : ''); ?>>
                                            <?php echo e($satuan->nama); ?> (<?php echo e($satuan->kode); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="coa_pembelian_id" id="coa_pembelian_id" class="form-select" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $coas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($coa->kode_akun); ?>" data-tipe="<?php echo e($coa->tipe_akun); ?>" data-kategori="<?php echo e($coa->kategori_akun); ?>" data-induk="<?php echo e($coa->kode_induk); ?>" <?php echo e(old('coa_pembelian_id', $bahanBaku->coa_pembelian_id) == $coa->kode_akun ? 'selected' : ''); ?>>
                                        <?php echo e($coa->nama_akun); ?> (<?php echo e($coa->kode_akun); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="coa_persediaan_id" id="coa_persediaan_id" class="form-select" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $coas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($coa->kode_akun); ?>" data-tipe="<?php echo e($coa->tipe_akun); ?>" data-kategori="<?php echo e($coa->kategori_akun); ?>" data-induk="<?php echo e($coa->kode_induk); ?>" <?php echo e(old('coa_persediaan_id', $bahanBaku->coa_persediaan_id) == $coa->kode_akun ? 'selected' : ''); ?>>
                                        <?php echo e($coa->nama_akun); ?> (<?php echo e($coa->kode_akun); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="coa_hpp_id" id="coa_hpp_id" class="form-select" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $coas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($coa->kode_akun); ?>" data-tipe="<?php echo e($coa->tipe_akun); ?>" data-kategori="<?php echo e($coa->kategori_akun); ?>" data-induk="<?php echo e($coa->kode_induk); ?>" <?php echo e(old('coa_hpp_id', $bahanBaku->coa_hpp_id) == $coa->kode_akun ? 'selected' : ''); ?>>
                                        <?php echo e($coa->nama_akun); ?> (<?php echo e($coa->kode_akun); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/master-data/bahan-baku/edit.blade.php ENDPATH**/ ?>