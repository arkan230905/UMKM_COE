...
<div class="container-fluid py-4">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $detailBahanBaku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bahan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php echo e(number_format($bahan['qty'], 2, ',', '.')); ?>

                                        </td>
                                        <td class="text-center">
                                            <?php echo e($bahan['satuan']); ?>
                ...
                <div class="alert alert-light">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <p class="mb-2">
                                ...
                                <span class="text-info fs-5">Rp <?php echo e(number_format($totalBBB, 0, ',', '.')); ?></span>
                                <br><small class="text-muted"><?php echo e($detailBahanBaku ? count($detailBahanBaku) : 0); ?> item</small>
                            </p>
                        </div>
                        <div class="col-md-4">
                            <p class="mb-2">
                                <strong>Total Bahan Pendukung:</strong><br>
                                <span class="text-warning fs-5">Rp <?php echo e(number_format($totalBahanPendukung, 0, ',', '.')); ?></span>
                                <br><small class="text-muted"><?php echo e($detailBahanPendukung ? count($detailBahanPendukung) : 0); ?> item</small>
                            </p>
                        </div>
                        <div class="col-md-4">
                            <p class="mb-2">
                                ...
                                <br><small class="text-muted"><?php echo e($allDetails ? count($allDetails) : 0); ?> item total</small>
                            </p>
                        </div>
                    </div>
                    <hr>
                    <div class="text-center">
                        <small class="text-muted">
                            ...
                            Total biaya bahan yang digunakan untuk memproduksi <strong><?php echo e($bom->produk->nama_produk); ?></strong>
                        </small>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-bold"><?php echo e($btkl['nama_jabatan']); ?></div>
                                                <small class="text-muted"><?php echo e($btkl['kategori'] ?? ''); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-bold text-primary"><?php echo e($btkl['jumlah_pegawai']); ?> orang</div>
                                                <small class="text-muted"><?php echo e($btkl['nama_jabatan']); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-bold text-success">Rp <?php echo e(number_format($btkl['tarif_btkl_total'], 0, ',', '.')); ?></div>
                                                <small class="text-muted"><?php echo e($btkl['jumlah_pegawai']); ?> pegawai × Rp <?php echo e(number_format($btkl['tarif_per_jam'], 0, ',', '.')); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-bold text-warning">Rp <?php echo e(number_format($btkl['biaya_per_produk'], 2, ',', '.')); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="card bg-light">
                            <div class="card-body py-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <h5 class="mb-0 text-success">Rp <?php echo e(number_format($totalBTKL, 2, ',', '.')); ?></h5>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card shadow-sm mb-3">
        ...
        <div class="card-body">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bomJobCosting && $bomJobCosting->bomProsesBops && $bomJobCosting->bomProsesBops->count() > 0): ?>
                <div class="table-responsive mb-4">
                    <table class="table table-hover align-middle mb-0 table-wide">
                        <thead class="table-light">
                            <tr>
                        ...
                        <tbody>
                            <?php $noBop = 1; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bomJobCosting->bomProsesBops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-bold"><?php echo e($bop->komponenBop->nama_komponen); ?></div>
                                                <small class="text-muted"><?php echo e($bop->komponenBop->keterangan); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end"><?php echo e(number_format($bop->jumlah, 2, ',', '.')); ?></td>
                                    <td>
                                        <span class="badge bg-info"><?php echo e($bop->satuan); ?></span>
                                    </td>
                                    <td class="text-end">Rp <?php echo e(number_format($bop->harga_satuan, 2, ',', '.')); ?></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center">
                                            <i class="bi bi-cash-stack me-2 text-success"></i>
                                            <div>
                                                <div class="fw-bold text-success">Rp <?php echo e(number_format($bop->subtotal, 2, ',', '.')); ?></div>
                        ...
                        <div class="card bg-light">
                            <div class="card-body py-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <h5 class="mb-0 text-warning">Rp <?php echo e(number_format($totalBOP, 2, ',', '.')); ?></h5>
                                </div>
                            </div>
                        </div>
                    </div>
