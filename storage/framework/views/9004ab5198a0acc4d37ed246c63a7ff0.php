                                        ...
                                        <div class="small">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $p->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mb-1">
                                                    ...
                                                    <?php elseif($detail->tipe_item === 'bahan_baku' && $detail->bahan_baku_id && !$detail->bahanBaku): ?>
                                                        Bahan Baku (ID: <?php echo e($detail->bahan_baku_id); ?>)
                                                    <?php elseif($detail->tipe_item === 'bahan_pendukung' && $detail->bahan_pendukung_id && !$detail->bahanPendukung): ?>
                                                        Bahan Pendukung (ID: <?php echo e($detail->bahan_pendukung_id); ?>)
