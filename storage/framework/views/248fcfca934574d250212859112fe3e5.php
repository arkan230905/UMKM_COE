...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo e(route('laporan.pembelian.export')); ?>" class="btn btn-danger">
    ...
    <div class="tab-content" id="laporanTabsContent">
        ...
        <div class="tab-pane fade <?php echo e(!request('tab') || request('tab') == 'pembelian' ? 'show active' : ''); ?>" 
            ...
            <?php echo $__env->make('laporan.pembelian.partials.pembelian-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="tab-pane fade <?php echo e(request('tab') == 'retur' ? 'show active' : ''); ?>" 
            ...
            <?php echo $__env->make('laporan.pembelian.partials.retur-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/laporan/pembelian/index.blade.php ENDPATH**/ ?>