...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body jabatan-form">
            <form method="POST" action="<?php echo e(route('master-data.kualifikasi-tenaga-kerja.update', $jabatan->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="gaji_pokok" class="form-control money-input" value="<?php echo e(old('gaji_pokok',$jabatan->gaji_pokok)); ?>">
                        <small class="text-white money-hint"></small>
                        <small class="text-white d-block">BTKTL: gaji per bulan. BTKL: isi 0.</small>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Tarif/Jam (Rp)</label>
                        <input type="text" name="tarif_lembur" class="form-control money-input" value="<?php echo e(old('tarif_lembur',$jabatan->tarif_lembur)); ?>">
                        <small class="text-white money-hint"></small>
