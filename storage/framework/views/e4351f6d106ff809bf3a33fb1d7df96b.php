    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Status Data Wajah -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasFaceData): ?>
                        <div class="alert alert-warning mb-3">
                            <i class="bi bi-exclamation-triangle me-2"></i>
                            <strong>Perhatian:</strong> Pegawai "<?php echo e($pegawai->nama); ?>" belum terdaftar verifikasi wajah.
                            Silakan daftarkan wajah terlebih dahulu melalui menu pendaftaran verifikasi wajah.
                            <br><small>
                                <a href="<?php echo e(route('transaksi.presensi.verifikasi-wajah.create')); ?>" class="btn btn-sm btn-warning mt-2">
                    ...
                    <?php else: ?>
                        <div class="alert alert-success mb-3">
                            ...
                            <strong>Status:</strong> Pegawai "<?php echo e($pegawai->nama); ?>" sudah terdaftar verifikasi wajah.
                            ...
                            <div class="col-md-6">
                                <select id="pegawaiSelect" class="form-select">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pegawai)): ?>
                                        <option value="<?php echo e($pegawai->kode_pegawai); ?>" selected>
...
<script src="https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@latest?v=<?php echo e(time()); ?>"></script>
<script src="https://cdn.jsdelivr.net/npm/@tensorflow-models/face-landmarks-detection@latest?v=<?php echo e(time()); ?>"></script>
<script>
// Version: <?php echo e(time()); ?> - Cache busting
...
function showResult(success, pegawaiData = null, status = null) {
    ...
    if (success && pegawaiData) {
        ...
        document.getElementById('pegawaiInfo').innerHTML = `
            ...
            <div class="mt-3">
                <a href="<?php echo e(route('transaksi.presensi.verifikasi-wajah.create')); ?>" class="btn btn-warning">
                    <i class="bi bi-plus-circle me-1"></i> Daftarkan Wajah Sekarang
                </a>
...
function backToSelection() {
    window.location.href = '<?php echo e(route("transaksi.presensi.verifikasi-wajah.create")); ?>';
}

function proceedToAttendance() {
    // Redirect to attendance page or save attendance
    window.location.href = '<?php echo e(route("transaksi.presensi.index")); ?>';
}
...
window.addEventListener('load', function() {
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pegawai)): ?>
        currentPegawai = '<?php echo e($pegawai->kode_pegawai); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\UMKM_COE\resources\views/transaksi/presensi/verifikasi-wajah/face-recognition.blade.php ENDPATH**/ ?>