...
<div class="container-fluid">
        ...
        <div class="col-md-2">
            <div class="card bg-light border-0">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 text-primary fw-bold">Rp <?php echo e(number_format($totalPenjualan, 0, ',', '.')); ?></h5>
                    <small class="<?php echo e($penjualanChange >= 0 ? 'text-success' : 'text-danger'); ?>">
                        <i class="fas fa-arrow-<?php echo e($penjualanChange >= 0 ? 'up' : 'down'); ?> me-1"></i><?php echo e(number_format(abs($penjualanChange), 1)); ?>% dari kemarin
                    </small>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card bg-light border-0">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 text-info fw-bold"><?php echo e(number_format($jumlahTransaksiHariIni, 0, ',', '.')); ?></h5>
                    <small class="<?php echo e($transaksiChange >= 0 ? 'text-success' : 'text-danger'); ?>">
                        <i class="fas fa-arrow-<?php echo e($transaksiChange >= 0 ? 'up' : 'down'); ?> me-1"></i><?php echo e(number_format(abs($transaksiChange), 1)); ?>% dari kemarin
                    </small>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card bg-light border-0">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 text-warning fw-bold"><?php echo e(number_format($totalProdukTerjual, 0, ',', '.')); ?></h5>
                    <small class="<?php echo e($produkChange >= 0 ? 'text-success' : 'text-danger'); ?>">
                        <i class="fas fa-arrow-<?php echo e($produkChange >= 0 ? 'up' : 'down'); ?> me-1"></i><?php echo e(number_format(abs($produkChange), 1)); ?>% dari kemarin
                    </small>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card bg-light border-0">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 text-info fw-bold">Rp <?php echo e(number_format($totalOngkir, 0, ',', '.')); ?></h5>
                    <small class="<?php echo e($ongkirChange >= 0 ? 'text-success' : 'text-danger'); ?>">
                        <i class="fas fa-arrow-<?php echo e($ongkirChange >= 0 ? 'up' : 'down'); ?> me-1"></i><?php echo e(number_format(abs($ongkirChange), 1)); ?>% dari kemarin
                    </small>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card bg-light border-0">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 text-danger fw-bold">Rp <?php echo e(number_format($totalDiskon, 0, ',', '.')); ?></h5>
                    <small class="<?php echo e($diskonChange >= 0 ? 'text-danger' : 'text-success'); ?>">
                        <i class="fas fa-arrow-<?php echo e($diskonChange >= 0 ? 'up' : 'down'); ?> me-1"></i><?php echo e(number_format(abs($diskonChange), 1)); ?>% dari kemarin
                    </small>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card bg-light border-0">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 <?php echo e($totalProfit >= 0 ? 'text-success' : 'text-danger'); ?> fw-bold">Rp <?php echo e(number_format($totalProfit, 0, ',', '.')); ?></h5>
                    <small class="<?php echo e($profitChange >= 0 ? 'text-success' : 'text-danger'); ?>">
                        <i class="fas fa-arrow-<?php echo e($profitChange >= 0 ? 'up' : 'down'); ?> me-1"></i><?php echo e(number_format(abs($profitChange), 1)); ?>% dari kemarin
                    </small>
                </div>
            </div>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form method="GET" action="<?php echo e(route('transaksi.penjualan.index')); ?>" class="row g-3">
                <div class="col-md-2">
                ...
                <div class="col-md-2 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('transaksi.penjualan.index')); ?>" class="btn btn-outline-secondary btn-sm" style="border-radius: 6px;">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $penjualan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="<?php echo e($key % 2 === 0 ? 'table-light' : ''); ?>">
                                <td class="text-center"><?php echo e($key + 1); ?></td>
                                <td><strong><?php echo e($penjualan->nomor_penjualan ?? '-'); ?></strong></td>
                                <td><?php echo e(optional($penjualan->tanggal_transaksi)->format('d-m-Y H:i') ?? '-'); ?></td>
                                <td>
                                    <span class="badge <?php echo e(($penjualan->payment_method ?? '') === 'credit' ? 'bg-warning' : 'bg-success'); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($penjualan->payment_method ?? ''):
                                            case ('cash'): ?> Tunai <?php break; ?>
                                            <?php case ('transfer'): ?> Transfer <?php break; ?>
                                            <?php case ('credit'): ?> Kredit <?php break; ?>
                                            <?php default: ?> Tidak Diketahui
                                        ...
                                        <div class="multi-product-container">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualan->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="product-item">
                                                    ...
                                                    <?php echo e($d->produk->nama_produk ?? '-'); ?>
                                ...
                                <td class="text-end">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailCount > 1): ?>
                                        <div class="multi-quantity">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualan->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="qty-item">
                                                    <strong><?php echo e(rtrim(rtrim(number_format($d->jumlah,2,',','.'),'0'),',')); ?></strong>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php elseif($detailCount === 1): ?>
                                        <div class="single-quantity">
                                            <strong><?php echo e(rtrim(rtrim(number_format($penjualan->details[0]->jumlah,2,',','.'),'0'),',')); ?></strong>
                                        </div>
                                    <?php else: ?>
                                        <div class="single-quantity">
                                            <strong><?php echo e(rtrim(rtrim(number_format($penjualan->jumlah,2,',','.'),'0'),',')); ?></strong>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="text-end">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailCount > 1): ?>
                                        <div class="multi-price">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualan->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <div class="price-item">Rp <?php echo e(number_format($hargaSatuan, 0, ',', '.')); ?></div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php elseif($detailCount === 1): ?>
                                ...
                                <td class="text-end">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailCount > 1): ?>
                                        <div class="multi-hpp">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualan->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="hpp-item">Rp <?php echo e(number_format($d->produk->getHPPForSaleDate($penjualan->tanggal), 0, ',', '.')); ?></div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php elseif($detailCount === 1): ?>
                                        <div class="single-hpp">
                                            Rp <?php echo e(number_format($penjualan->details[0]->produk->getHPPForSaleDate($penjualan->tanggal), 0, ',', '.')); ?>
                                    ...
                                    <?php else: ?>
                                        <div class="single-hpp">
                                            ...
                                            ?>
                                            Rp <?php echo e(number_format($hppValue, 0, ',', '.')); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailCount > 1): ?>
                                        <div class="multi-profit">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualan->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="profit-item <?php echo e($margin > 0 ? 'text-success' : 'text-danger'); ?>">Rp <?php echo e(number_format($margin, 0, ',', '.')); ?></div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php elseif($detailCount === 1): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailCount > 1): ?>
                                        <div class="multi-discount">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualan->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="discount-item"><?php echo e(number_format($pct, 0)); ?>% (Rp <?php echo e(number_format($disc, 0, ',', '.')); ?>)</div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php elseif($detailCount === 1): ?>
                                        <div class="single-discount">
                                            ...
                                            <?php echo e(number_format($pct, 0)); ?>% (Rp <?php echo e(number_format($disc, 0, ',', '.')); ?>)
                                        </div>
                                    <?php else: ?>
                                        <div class="single-discount">
                                            <?php 
                                ...
                                <td class="text-end fw-semibold"><strong>Rp <?php echo e(number_format($penjualan->grand_total ?? $penjualan->total, 0, ',', '.')); ?></strong></td>
                                <td>
                                    <?php
                                        $totalQtyRetur = $penjualan->total_qty_retur;
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalQtyRetur > 0): ?>
                                        <span class="badge bg-danger animate-pulse">
                                            <i class="fas fa-undo me-1"></i><?php echo e((int)$totalQtyRetur); ?>
                                ...
                                <td class="text-center">
                                    <div class="action-layout">
                                        <div class="action-row gap-1 mb-1">
                                            <button type="button" class="btn-minimal btn-detail" data-bs-toggle="modal" data-bs-target="#detailModal<?php echo e($penjualan->id); ?>" title="Detail Transaksi">
                                                Detail
                                            </button>
                                            <a href="<?php echo e(route('transaksi.penjualan.edit', $penjualan->id)); ?>" class="btn-minimal btn-warning" data-bs-toggle="tooltip" title="Edit Transaksi">
                                                Edit
                                            </a>
                                            <a href="<?php echo e(route('akuntansi.jurnal-umum', ['ref_type' => 'sale', 'ref_id' => $penjualan->id])); ?>" class="btn-minimal btn-jurnal" data-bs-toggle="tooltip" title="Lihat Jurnal">
                                                Jurnal
                                            </a>
                                        </div>
                                        <div class="action-row gap-1">
                                            <button type="button" class="btn-minimal btn-success" data-bs-toggle="modal" data-bs-target="#strukModal<?php echo e($penjualan->id); ?>" title="Cetak Struk">
                                                Cetak
                                            </button>
                                            <a href="<?php echo e(route('transaksi.retur-penjualan.detail-retur', $penjualan->id)); ?>" class="btn-minimal btn-info" data-bs-toggle="tooltip" title="Proses Retur">
                                                Retur
                                            </a>
                                            <button type="submit" class="btn-minimal btn-danger" onclick="confirmDelete(<?php echo e($penjualan->id); ?>)" data-bs-toggle="tooltip" title="Hapus Transaksi">
                                                Hapus
                                            </button>
                                        </div>
                                    </div>
                                    <!-- Hidden form for delete -->
                                    <form id="deleteForm<?php echo e($penjualan->id); ?>" action="<?php echo e(route('transaksi.penjualan.destroy', $penjualan->id)); ?>" method="POST" style="display: none;">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="tab-pane fade" id="retur-list" role="tabpanel" aria-labelledby="retur-list-tab">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $salesReturns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $retur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($key + 1); ?></td>
                                        <td><?php echo e(optional($retur->tanggal)->format('d-m-Y') ?? '-'); ?></td>
                                        <td><strong><?php echo e($retur->penjualan?->nomor_penjualan ?? '-'); ?></strong></td>
                                        <td><?php echo e($retur->keterangan ?? '-'); ?></td>
                                        <td>
                                            <?php
                                            ...
                                            ?>
                                            <span class="badge <?php echo e($jenisRetur === 'refund' ? 'bg-danger' : ($jenisRetur === 'tukar_barang' ? 'bg-warning' : 'bg-info')); ?>">
                                                <?php echo e($jenisLabel); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($retur->status === 'selesai' ? 'bg-success' : ($retur->status === 'lunas' ? 'bg-info' : 'bg-warning')); ?>">
                                                <?php echo e(ucfirst($retur->status ?? '-')); ?>

                                            </span>
                                        </td>
                                        <td class="text-end fw-semibold">Rp <?php echo e(number_format($retur->total_retur ?? 0, 0, ',', '.')); ?></td>
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($retur->detailReturPenjualans->count() > 0): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $retur->detailReturPenjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div><?php echo e($item->produk?->nama_produk ?? '-'); ?></div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <td class="text-center">
                                            <div class="action-layout">
                                                <div class="action-row gap-1">
                                                    <button type="button" class="btn-minimal btn-detail" data-bs-toggle="modal" data-bs-target="#returDetailModal<?php echo e($retur->id); ?>" title="Detail Retur">
                                                        Detail
                                                    </button>
                                                    <a href="<?php echo e(route('transaksi.retur-penjualan.edit', $retur->id)); ?>" class="btn-minimal btn-warning" data-bs-toggle="tooltip" title="Edit Retur">
                                                        Edit
                                                    </a>
                                                    <button type="button" class="btn-minimal btn-danger" onclick="confirmDeleteRetur(<?php echo e($retur->id); ?>)" data-bs-toggle="tooltip" title="Hapus Retur">
                                                        Hapus
                                                    </button>
                                                </div>
                                            </div>
                                            <!-- Hidden form for delete retur -->
                                            <form id="deleteReturForm<?php echo e($retur->id); ?>" action="<?php echo e(route('transaksi.retur-penjualan.destroy', $retur->id)); ?>" method="POST" style="display: none;">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                            </form>
                                        </td>
...
<!-- Detail Modal -->
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penjualan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="detailModal<?php echo e($penjualan->id); ?>" tabindex="-1" aria-labelledby="detailModalLabel<?php echo e($penjualan->id); ?>" aria-hidden="true" style="z-index: 1055;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailModalLabel<?php echo e($penjualan->id); ?>">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <strong>Nomor Transaksi:</strong> <?php echo e($penjualan->nomor_penjualan ?? '-'); ?>

                    </div>
                    <div class="col-md-6">
                        <strong>Tanggal:</strong> <?php echo e(optional($penjualan->tanggal)->format('d-m-Y') ?? $penjualan->tanggal); ?>

                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <strong>Pelanggan:</strong> <?php echo e($penjualan->pelanggan?->name ?? 'Umum'); ?>

                    </div>
                    <div class="col-md-6">
                        <strong>Status Transaksi:</strong> 
                        <span class="badge <?php echo e(($penjualan->status ?? 'lunas') === 'lunas' ? 'bg-success' : 'bg-warning'); ?>">
                            <?php echo e(ucfirst($penjualan->status ?? 'lunas')); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <strong>Catatan:</strong> <?php echo e($penjualan->catatan ?? '-'); ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalQtyRetur > 0): ?>
                            <span class="badge bg-info"><?php echo e((int)$totalQtyRetur); ?></span>
                        <?php else: ?>
                    ...
                    <table class="table table-sm table-bordered mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-end">HPP</th>
                                <th class="text-end">Profit</th>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adaDiskonModal): ?><th class="text-end">Diskon</th><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailCount > 1): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualan->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">Rp <?php echo e(number_format($d->harga_satuan ?? 0, 0, ',', '.')); ?></td>
                                        <td class="text-end">Rp <?php echo e(number_format($actualHPP, 0, ',', '.')); ?></td>
                                        <td class="text-end <?php echo e($margin > 0 ? 'text-success' : 'text-danger'); ?>">Rp <?php echo e(number_format($margin, 0, ',', '.')); ?></td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adaDiskonModal): ?>
                                        <td class="text-end text-danger">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($d->diskon_persen ?? 0) > 0): ?>
                                                <?php echo e(number_format($d->diskon_persen, 0)); ?>%<br>
                                                <small>-Rp <?php echo e(number_format($diskonNom, 0, ',', '.')); ?></small>
                                            <?php else: ?> -
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><?php echo e(rtrim(rtrim(number_format($penjualan->jumlah,4,',','.'),'0'),',')); ?></td>
                                    <td class="text-end">Rp <?php echo e(number_format($hdrHarga ?? 0, 0, ',', '.')); ?></td>
                                    <td class="text-end">Rp <?php echo e(number_format($actualHPP, 0, ',', '.')); ?></td>
                                    <td class="text-end <?php echo e($margin > 0 ? 'text-success' : 'text-danger'); ?>">Rp <?php echo e(number_format($margin, 0, ',', '.')); ?></td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adaDiskonModal): ?>
                                    <td class="text-end text-danger">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalDiskonModal > 0): ?> -Rp <?php echo e(number_format($totalDiskonModal, 0, ',', '.')); ?>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-between align-items-center py-1">
                            ...
                            <span class="fw-bold">Rp <?php echo e(number_format($totalSubtotal + $totalDiskonModal, 0, ',', '.')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-between align-items-center py-1">
                            ...
                            <span class="fw-bold <?php echo e(($penjualan->biaya_ongkir ?? 0) > 0 ? 'text-warning' : ''); ?>">
                                Rp <?php echo e(number_format($penjualan->biaya_ongkir ?? 0, 0, ',', '.')); ?>
                    ...
                    <!-- Diskon -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalDiskonModal > 0): ?>
                    <div class="col-md-6">
                        <div class="d-flex justify-content-between align-items-center py-1">
                            <span class="text-muted">Total Diskon:</span>
                            <span class="fw-bold text-danger">-Rp <?php echo e(number_format($totalDiskonModal, 0, ',', '.')); ?></span>
                        </div>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-between align-items-center py-1">
                            ...
                            ?>
                            <span class="text-muted">PPN (<?php echo e($ppnPersen > 0 ? number_format($ppnPersen, 0) : '0'); ?>%):</span>
                            <span class="fw-bold <?php echo e($biayaPPN > 0 ? 'text-secondary' : ''); ?>">
                                Rp <?php echo e(number_format($biayaPPN, 0, ',', '.')); ?>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <span class="fw-bold fs-5 text-primary">
                        Rp <?php echo e(number_format($penjualan->grand_total ?? $penjualan->total, 0, ',', '.')); ?>
                ...
                <div class="mb-4">
                    ...
                    <form id="uploadBuktiFormModal<?php echo e($penjualan->id); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <input type="file" class="form-control" id="bukti_file_modal<?php echo e($penjualan->id); ?>" name="bukti_file" 
                                           accept="image/*,.pdf,.doc,.docx" required>
                                    <div class="form-text">Format: JPG, PNG, PDF (Max 5MB)</div>
                                    <div class="invalid-feedback" id="file-error-modal<?php echo e($penjualan->id); ?>"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="keterangan_modal<?php echo e($penjualan->id); ?>" name="keterangan" 
                ...
                <div class="mb-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($buktiPembayaranModal->count() > 0): ?>
                        <div class="row">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $buktiPembayaranModal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bukti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-4 mb-3">
                                    <div class="card bukti-card">
                                        <div class="card-body text-center p-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array(strtolower(pathinfo($bukti->file_path, PATHINFO_EXTENSION)), ['jpg', 'jpeg', 'png', 'gif'])): ?>
                                                <img src="<?php echo e(url('/storage/' . $bukti->file_path)); ?>" 
                                                     class="img-fluid rounded mb-2 bukti-image" 
                                                     style="max-height: 120px; cursor: pointer;"
                                                     onclick="showImageModalPreview('<?php echo e(url('/storage/' . $bukti->file_path)); ?>', '<?php echo e($bukti->keterangan ?? 'Bukti Pembayaran'); ?>')">
                                            <?php else: ?>
                                                <div class="text-center py-3">
                                                    <i class="fas fa-file-alt fa-2x text-muted mb-2"></i>
                                                    <p class="mb-0 small"><?php echo e(basename($bukti->file_path)); ?></p>
                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            
                                            <small class="text-muted d-block mb-1"><?php echo e($bukti->keterangan ?? 'Bukti Pembayaran'); ?></small>
                                            <small class="text-muted d-block mb-2"><?php echo e($bukti->created_at->format('d/m/Y H:i')); ?></small>
                                            
                                            <div class="bukti-actions">
                                                <a href="<?php echo e(url('/storage/' . $bukti->file_path)); ?>" 
                                                   target="_blank" 
                                                ...
                                                <button type="button" 
                                                        ...
                                                        onclick="deleteBuktiModal(<?php echo e($bukti->id); ?>, <?php echo e($penjualan->id); ?>)"
                                                        title="Hapus">
                ...
                <!-- Detail Retur -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($penjualan->returPenjualans && $penjualan->returPenjualans->count() > 0): ?>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualan->returPenjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $retur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><strong><?php echo e($retur->nomor_retur); ?></strong></td>
                                <td><?php echo e($retur->tanggal->format('d/m/Y')); ?></td>
                                <td>
                                    <span class="badge <?php echo e($retur->jenis_retur === 'refund' ? 'bg-danger' : ($retur->jenis_retur === 'tukar_barang' ? 'bg-warning' : 'bg-info')); ?>">
                                        <?php echo e($retur->jenis_retur === 'tukar_barang' ? 'Tukar Barang' : ($retur->jenis_retur === 'refund' ? 'Refund' : 'Kredit')); ?>

                                    </span>
                                </td>
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($retur->detailReturPenjualans && $retur->detailReturPenjualans->count() > 0): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $retur->detailReturPenjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div><?php echo e($detail->produk?->nama_produk ?? '-'); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php else: ?>
                                        -
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <td class="text-end">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($retur->detailReturPenjualans && $retur->detailReturPenjualans->count() > 0): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $retur->detailReturPenjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div><?php echo e((int)($detail->qty_retur ?? 0)); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php else: ?>
                                        -
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="text-end">Rp <?php echo e(number_format($retur->total_retur ?? 0, 0, ',', '.')); ?></td>
                                <td>
                                    <span class="badge <?php echo e($retur->status === 'selesai' ? 'bg-success' : ($retur->status === 'lunas' ? 'bg-info' : 'bg-warning')); ?>">
                                        <?php echo e(ucfirst($retur->status ?? '-')); ?>
            ...
            <div class="modal-footer">
                <a href="<?php echo e(route('transaksi.penjualan.show', $penjualan->id)); ?>" class="btn btn-primary">
...
<!-- Struk Modal -->
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penjualan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="strukModal<?php echo e($penjualan->id); ?>" tabindex="-1" aria-labelledby="strukModalLabel<?php echo e($penjualan->id); ?>" aria-hidden="true" style="z-index: 1055;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="strukModalLabel<?php echo e($penjualan->id); ?>">
                    <i class="fas fa-print me-2"></i>Struk Penjualan
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div id="strukContent<?php echo e($penjualan->id); ?>">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                <button type="button" class="btn btn-primary" onclick="printStruk('strukContent<?php echo e($penjualan->id); ?>')">
...
<!-- Retur Detail Modal -->
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $salesReturns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $retur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="returDetailModal<?php echo e($retur->id); ?>" tabindex="-1" aria-labelledby="returDetailModalLabel<?php echo e($retur->id); ?>" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="returDetailModalLabel<?php echo e($retur->id); ?>">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <strong>Nomor Retur:</strong> <?php echo e($retur->nomor_retur ?? '-'); ?>

                    </div>
                    <div class="col-md-6">
                        <strong>Tanggal Retur:</strong> <?php echo e(optional($retur->tanggal)->format('d-m-Y') ?? '-'); ?>

                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <strong>Nomor Penjualan:</strong> <?php echo e($retur->penjualan?->nomor_penjualan ?? '-'); ?>

                    </div>
                    <div class="col-md-6">
                        <strong>Tanggal Penjualan:</strong> <?php echo e(optional($retur->penjualan?->tanggal)->format('d-m-Y') ?? '-'); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <span class="text-danger fw-semibold">Rp <?php echo e(number_format($retur->total_retur ?? 0, 0, ',', '.')); ?></span>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-12">
                        <strong>Keterangan:</strong> <?php echo e($retur->keterangan ?? '-'); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($retur->detailReturPenjualans->count() > 0): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $retur->detailReturPenjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-end"><?php echo e(number_format($item->qty_retur ?? 0, 0, ',', '.')); ?></td>
                                        <td class="text-end">Rp <?php echo e(number_format($item->harga_barang ?? 0, 0, ',', '.')); ?></td>
                                        <td class="text-end">Rp <?php echo e(number_format(($item->qty_retur ?? 0) * ($item->harga_barang ?? 0), 0, ',', '.')); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
                                <tr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const strukModal<?php echo e($penjualan->id); ?> = document.getElementById('strukModal<?php echo e($penjualan->id); ?>');
    if(strukModal<?php echo e($penjualan->id); ?>) {
        strukModal<?php echo e($penjualan->id); ?>.addEventListener('shown.bs.modal', function () {
            loadStruk(<?php echo e($penjualan->id); ?>);
        });
    }
...
function loadSettingData() {
    const url = '<?php echo e(route("transaksi.penjualan-setting.index")); ?>';
...
function toggleOngkirStatus(id, status) {
    ...
    fetch('<?php echo e(route("transaksi.penjualan-setting.index")); ?>')
        .then(r => r.json())
        .then(data => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/transaksi/penjualan/index.blade.php ENDPATH**/ ?>