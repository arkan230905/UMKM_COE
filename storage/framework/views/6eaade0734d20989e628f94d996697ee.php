...
<div class="container-fluid py-4" style="background-color: #1b1b28; min-height: 100vh;">
    ...
    <div class="card border-0 shadow-sm mx-3" style="background-color: #222232; border-radius: 15px;">
        <div class="card-body p-4">
            <form action="<?php echo e(route('master-data.presensi.update', $presensi->id)); ?>" method="POST" id="presensiForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <?php $__currentLoopData = $pegawais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pegawai->id); ?>" 
                                    <?php echo e(old('pegawai_id', $presensi->pegawai_id) == $pegawai->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('tgl_presensi', \Carbon\Carbon::parse($presensi->tgl_presensi)->format('Y-m-d'))); ?>" 
                               required
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="Hadir" <?php echo e(old('status', $presensi->status) == 'Hadir' ? 'selected' : ''); ?> class="text-white">
                                Hadir
                            </option>
                            <option value="Izin" <?php echo e(old('status', $presensi->status) == 'Izin' ? 'selected' : ''); ?> class="text-white">
                                Izin
                            </option>
                            <option value="Sakit" <?php echo e(old('status', $presensi->status) == 'Sakit' ? 'selected' : ''); ?> class="text-white">
                                Sakit
                            </option>
                            <option value="Alpa" <?php echo e(old('status', $presensi->status) == 'Alpa' ? 'selected' : ''); ?> class="text-white">
                                Alpa
                            </option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- Jam Masuk -->
                    <div class="col-md-6 jam-field" style="<?php echo e($presensi->status != 'Hadir' ? 'display: none;' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('jam_masuk', $presensi->status == 'Hadir' ? \Carbon\Carbon::parse($presensi->jam_masuk)->format('H:i') : '08:00')); ?>" 
                               <?php echo e($presensi->status != 'Hadir' ? 'disabled' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('jam_keluar', $presensi->status == 'Hadir' ? \Carbon\Carbon::parse($presensi->jam_keluar)->format('H:i') : '17:00')); ?>" 
                               <?php echo e($presensi->status != 'Hadir' ? 'disabled' : ''); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\COE_EADT_UMKM_COMPLETE\resources\views/master-data/presensi/edit.blade.php ENDPATH**/ ?>