...
<div class="container-fluid">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success') || request('notify')): ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <i class="fas fa-check-circle me-2"></i><?php echo e(session('success') ?? request('notify')); ?>

            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error') || request('notify_error')): ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <i class="fas fa-exclamation-circle me-2"></i><?php echo e(session('error') ?? request('notify_error')); ?>
    ...
    <div class="card">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-semibold">Rp <?php echo e(number_format($row->tunjangan_transport,0,',','.')); ?></td>
                            <td class="fw-semibold">Rp <?php echo e(number_format($row->tunjangan_konsumsi,0,',','.')); ?></td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    <a href="<?php echo e(route('master-data.kualifikasi-tenaga-kerja.edit',$row->id)); ?>" class="btn btn-outline-primary btn-sm" style="padding: 0.25rem 0.5rem;">
                                        <i class="fas fa-edit fa-xs"></i>
                                    </a>
                                    <form action="<?php echo e(route('master-data.kualifikasi-tenaga-kerja.destroy',$row->id)); ?>" method="POST" class="m-0" onsubmit="return confirm('Yakin ingin menghapus kualifikasi <?php echo e($row->nama); ?>?')">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="card-footer">
            <?php echo e($jabatans->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/master-data/jabatan/index.blade.php ENDPATH**/ ?>