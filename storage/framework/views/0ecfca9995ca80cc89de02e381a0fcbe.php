...
<div class="container-fluid px-4 py-4">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bom): ?>
                                        ...
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <button type="button" 
                                                    ...
                                                    data-bs-target="#hitungBomModal<?php echo e($bom->id); ?>"
                                                    data-bs-toggle="tooltip" 
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($produk->boms->first()): ?>
            <div class="modal fade" id="hitungBomModal<?php echo e($produk->boms->first()->id); ?>" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-info text-white">
                            <h5 class="modal-title">
                                <i class="fas fa-calculator"></i> Hitung Ulang BOM - <?php echo e($produk->nama_produk); ?>

                            </h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                        </div>
                        <form action="<?php echo e(route('master-data.bom.update-bom-costs', $produk->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo e(number_format($produk->total_biaya_bahan, 0, ',', '.')); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Rp</span>
                                                <input type="text" class="form-control" value="<?php echo e(number_format($produk->total_btkl, 0, ',', '.')); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" 
                                                       ...
                                                       value="<?php echo e($produk->total_bop ?? 0); ?>"
                                                       min="0" 
                                                       step="1000"
                                                       placeholder="0">
                                            </div>
                                        ...
                                        <div class="card bg-light">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between mb-2">
                                                    ...
                                                    <strong>Rp <?php echo e(number_format($produk->total_biaya_bahan, 0, ',', '.')); ?></strong>
                                                </div>
                                                <div class="d-flex justify-content-between mb-2">
                                                    <span>Biaya BTKL:</span>
                                                    <strong>Rp <?php echo e(number_format($produk->total_btkl, 0, ',', '.')); ?></strong>
                                                </div>
                                                <div class="d-flex justify-content-between mb-2">
                                                    <span>Biaya BOP:</span>
                                                    <strong id="bop_display">Rp <?php echo e(number_format($produk->total_bop ?? 0, 0, ',', '.')); ?></strong>
                                                </div>
                                                <hr>
                                                <div class="d-flex justify-content-between">
                                                    <span class="fs-5">Total HPP:</span>
                                                    <strong class="fs-5 text-success" id="total_display">Rp <?php echo e(number_format($produk->total_biaya_bahan + $produk->total_btkl + ($produk->total_bop ?? 0), 0, ',', '.')); ?></strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
