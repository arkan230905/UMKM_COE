                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $prosesProduksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $proses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><code><?php echo e($proses->kode_proses ?? 'N/A'); ?></code></td>
                                <td>
                                ...
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proses->jabatan): ?>
                                        <div class="d-flex align-items-center">
                                            <div class="rounded-circle bg-success bg-opacity-10 p-1 me-2">
                                                <i class="fas fa-users text-success"></i>
                                            </div>
                                            <div>
                                                <div class="fw-semibold"><?php echo e($proses->jabatan->nama); ?></div>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="text-end">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proses->jabatan): ?>
                                        <?php echo e($proses->jabatan->pegawais->count()); ?> pegawai @ Rp <?php echo e(number_format($proses->jabatan->tarif, 0, ',', '.')); ?>/jam
                                    <?php else: ?>
                                        <span class="text-muted">N/A</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="text-end">
                                    ...
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tarifBtklCalculated > 0): ?>
                                        <div class="fw-semibold">Rp <?php echo e(number_format($tarifBtklCalculated, 0, ',', '.')); ?></div>
                                ...
                                <td class="text-end" 
                                    data-biaya-per-produk="<?php echo e($proses->kapasitas_per_jam > 0 ? number_format($tarifBtklCalculated / $proses->kapasitas_per_jam, 0, ',', '.') : '0'); ?>"
                                    data-tarif="<?php echo e(number_format($tarifBtklCalculated, 0, ',', '.')); ?>"
                                    data-kapasitas="<?php echo e($proses->kapasitas_per_jam); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proses->kapasitas_per_jam > 0 && $tarifBtklCalculated > 0): ?>
                                        <?php
                                            $biayaPerProduk = $tarifBtklCalculated / $proses->kapasitas_per_jam;
                                        ?>
                                        <div class="fw-semibold text-success">Rp <?php echo e(number_format($biayaPerProduk, 0, ',', '.')); ?></div>
                ...
                <div class="card-footer bg-primary bg-opacity-10">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-end">
                            ...
                            ?>
                            <div class="display-6 fw-bold text-primary">Rp <?php echo e(number_format($totalBiayaPerProduk, 0, ',', '.')); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer bg-light">
                    <div class="row text-center">
                        ...
                        <div class="col-md-3">
                            ...
                            ?>
                            <div class="fw-bold text-warning">Rp <?php echo e(number_format($avgBiayaPerUnit, 0, ',', '.')); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/master-data/proses-produksi/index.blade.php ENDPATH**/ ?>