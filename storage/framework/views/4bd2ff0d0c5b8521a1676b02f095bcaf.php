                        ...
                        <tbody>
                            <?php $__currentLoopData = $boms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-end">Rp <?php echo e(number_format((float)($bom->total_biaya ?? 0), 0, ',', '.')); ?></td>
                                    <td class="text-end"><?php echo e(number_format((float)($bom->persentase_keuntungan ?? 0), 2)); ?>%</td>
                                    <td class="text-end fw-bold">Rp <?php echo e(number_format((float)($bom->harga_jual ?? ($bom->total_biaya ?? 0) + (($bom->persentase_keuntungan ?? 0)/100.0 * ($bom->total_biaya ?? 0))), 0, ',', '.')); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\COE_EADT_UMKM_COMPLETE\resources\views/master-data/bom/index.blade.php ENDPATH**/ ?>