...
<div class="container-fluid px-4 py-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body jabatan-form">
            <form method="POST" action="<?php echo e(route('master-data.jabatan.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="mt-4">
                    ...
                    <a href="<?php echo e(route('master-data.jabatan.index')); ?>" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\COE_EADT_UMKM_COMPLETE\resources\views/master-data/jabatan/create.blade.php ENDPATH**/ ?>