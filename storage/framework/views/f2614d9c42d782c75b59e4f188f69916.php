        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select name="kode_induk" class="form-select">
                    ...
                    <?php $__currentLoopData = $coas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($p->kode_akun); ?>"><?php echo e($p->kode_akun); ?> - <?php echo e($p->nama_akun); ?></option>
...
(function(){
    ...
    document.querySelector('form[action="<?php echo e(route('master-data.coa.store')); ?>"]').addEventListener('submit', ()=>{
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\COE_EADT_UMKM_COMPLETE\resources\views/master-data/coa/create.blade.php ENDPATH**/ ?>