...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('transaksi.pembelian.store')); ?>" method="POST" enctype="multipart/form-data" onsubmit="debugFormData(this)">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-section">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <select name="vendor_id" class="form-select" required onchange="updateItemsBasedOnVendor(this)">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($vendor->id); ?>" data-kategori="<?php echo e($vendor->kategori); ?>"><?php echo e($vendor->nama_vendor); ?> (<?php echo e($vendor->kategori); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="nomor_faktur" class="form-control" placeholder="0232000002" value="<?php echo e(old('nomor_faktur')); ?>" required>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['nomor_faktur'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-3">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['bukti_faktur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kasbank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kb->nama_akun): ?>
                                <option value="<?php echo e($kb->id); ?>">
                                    ...
                                    (Saldo: Rp <?php echo e(number_format($kb->saldo_realtime ?? $kb->saldo_awal ?? 0, 0, ',', '.')); ?>)
                                </option>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="satuan_pembelian[]" class="form-select satuan-select" onchange="calculateRowTotal(this)">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($satuan->id); ?>" data-nama="<?php echo e($satuan->nama); ?>"><?php echo e($satuan->nama); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                        </div>
...
const subSatuanData = <?php echo json_encode($subSatuanData, 15, 512) ?>;
    ...
    if (vendorSelect.value) {
        ...
        if (kategori === 'Bahan Baku') {
            ...
            <?php $__currentLoopData = $bahanBakus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                itemSelect.innerHTML += '<option value="<?php echo e($bb->id); ?>" data-satuan="<?php echo e($bb->satuan->nama ?? 'Unit'); ?>" data-tipe="bahan_baku"><?php echo e($bb->nama_bahan); ?></option>';
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        } else if (kategori === 'Bahan Pendukung') {
            itemSelect.disabled = false;
            tipeItemInput.value = 'bahan_pendukung';
            <?php $__currentLoopData = $bahanPendukungs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                itemSelect.innerHTML += '<option value="<?php echo e($bp->id); ?>" data-satuan="<?php echo e($bp->satuanRelation->nama ?? 'Unit'); ?>" data-tipe="bahan_pendukung"><?php echo e($bp->nama_bahan); ?></option>';
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        }
    ...
    document.querySelectorAll('.item-select').forEach(itemSelect => {
        ...
        if (kategori === 'Bahan Baku') {
            ...
            <?php $__currentLoopData = $bahanBakus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                itemSelect.innerHTML += '<option value="<?php echo e($bb->id); ?>" data-satuan="<?php echo e($bb->satuan->nama ?? 'Unit'); ?>" data-tipe="bahan_baku" data-coa-kode="<?php echo e($coaKode); ?>" data-coa-nama="<?php echo e($coaNama); ?>"><?php echo e($bb->nama_bahan); ?></option>';
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        } else if (kategori === 'Bahan Pendukung') {
            itemSelect.disabled = false;
            tipeItemInput.value = 'bahan_pendukung';
            <?php $__currentLoopData = $bahanPendukungs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                itemSelect.innerHTML += '<option value="<?php echo e($bp->id); ?>" data-satuan="<?php echo e($bp->satuanRelation->nama ?? 'Unit'); ?>" data-tipe="bahan_pendukung" data-coa-kode="<?php echo e($coaKode); ?>" data-coa-nama="<?php echo e($coaNama); ?>"><?php echo e($bp->nama_bahan); ?></option>';
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        } else {
            itemSelect.disabled = true;
            tipeItemInput.value = '';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/transaksi/pembelian/create.blade.php ENDPATH**/ ?>