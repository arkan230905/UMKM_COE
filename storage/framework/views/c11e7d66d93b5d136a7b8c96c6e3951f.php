<div class="sidebar">
    ...
    <div class="sidebar-nav">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->is('master-data/proses-produksi*') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.proses-produksi.index')); ?>">
                    <i class="fas fa-fw fa-cogs"></i>
                    <span>Proses Produksi</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->is('master-data/komponen-bop*') ? 'active' : ''); ?>" href="<?php echo e(route('master-data.komponen-bop.index')); ?>">
