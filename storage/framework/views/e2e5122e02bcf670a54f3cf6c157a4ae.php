        ...
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <select name="tipe_akun" id="tipe_akun" class="form-select" required>
                    ...
                    <?php $__currentLoopData = $tipeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\COE_EADT_UMKM_COMPLETE\resources\views/master-data/coa/edit.blade.php ENDPATH**/ ?>