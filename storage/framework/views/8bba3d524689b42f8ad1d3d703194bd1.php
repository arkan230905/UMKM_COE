            ...
            <form method="POST" action="<?php echo e(route('master-data.kualifikasi-tenaga-kerja.store')); ?>">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="tunjangan_transport" class="form-control money-input" value="<?php echo e(old('tunjangan_transport',0)); ?>">
                        <small class="money-hint"></small>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Tunjangan Konsumsi (Rp)</label>
                        <input type="text" name="tunjangan_konsumsi" class="form-control money-input" value="<?php echo e(old('tunjangan_konsumsi',0)); ?>">
                        <small class="money-hint"></small>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="gaji" class="form-control money-input" value="<?php echo e(old('gaji',0)); ?>">
                        <small class="money-hint"></small>
                        <small class="d-block">BTKTL: gaji per bulan. BTKL: isi 0.</small>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Tarif/Jam (Rp)</label>
                        <input type="text" name="tarif" class="form-control money-input" value="<?php echo e(old('tarif',0)); ?>">
                        <small class="money-hint"></small>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/master-data/jabatan/create.blade.php ENDPATH**/ ?>