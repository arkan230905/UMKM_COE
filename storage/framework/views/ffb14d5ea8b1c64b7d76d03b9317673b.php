...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">BOP Budget - <?php echo e(\Carbon\Carbon::parse($periode)->isoFormat('MMMM YYYY')); ?></h5>
            <div class="d-flex align-items-center gap-2">
                <form method="GET" class="form-inline me-2">
                    <input type="month" name="periode" id="periode" class="form-control" 
                           value="<?php echo e($periode); ?>" onchange="this.form.submit()" style="width: 180px;">
                </form>
                <a href="<?php echo e(route('master-data.bop-budget.create', ['periode' => $periode])); ?>" class="btn btn-primary">
...
<script>
    $(document).ready(function() {
        const table = $('#bop-budget-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo e(route("master-data.bop-budget.index")); ?>',
                type: 'GET',
                data: function(d) {
                    d.periode = '<?php echo e($periode); ?>';
                },
            ...
            drawCallback: function() {
                $('.delete-btn').click(function(e) {
                    ...
                    const url = '<?php echo e(route("master-data.bop-budget.destroy", ":id")); ?>'.replace(':id', id);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\COE_EADT_UMKM_COMPLETE\resources\views/master-data/bop-budget/index.blade.php ENDPATH**/ ?>