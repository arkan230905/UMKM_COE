...
<div class="container">
  ...
  <form action="<?php echo e(route('transaksi.expense-payment.store')); ?>" method="POST"><?php echo csrf_field(); ?>
    <div class="mb-3">
    ...
    <a href="<?php echo e(route('transaksi.expense-payment.index')); ?>" class="btn btn-secondary">Batal</a>
  </form>
</div>
