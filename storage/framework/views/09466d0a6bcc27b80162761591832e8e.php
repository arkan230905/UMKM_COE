...
<div class="container">
    ...
    <form action="<?php echo e(route('transaksi.penjualan.update',$penjualan->id)); ?>" method="POST" id="form-penjualan">
        <?php echo csrf_field(); ?>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-3">
                ...
                <input type="date" name="tanggal" class="form-control" value="<?php echo e($penjualan->tanggal); ?>" required>
            </div>
            <div class="col-md-3">
                <label class="form-label">Metode Pembayaran</label>
                <select name="payment_method" id="payment_method_jual" class="form-select" required>
                    <option value="cash" <?php echo e($penjualan->payment_method == 'cash' ? 'selected' : ''); ?>>Tunai</option>
                    <option value="transfer" <?php echo e($penjualan->payment_method == 'transfer' ? 'selected' : ''); ?>>Transfer Bank</option>
                    <option value="credit" <?php echo e($penjualan->payment_method == 'credit' ? 'selected' : ''); ?>>Kredit</option>
                </select>
            </div>
            <div class="col-md-6" id="sumber_dana_wrapper_jual">
                ...
                <select name="sumber_dana" id="sumber_dana_jual" class="form-select">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kasbank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($kb->kode_akun); ?>" <?php echo e($penjualan->sumber_dana == $kb->kode_akun ? 'selected' : ''); ?>>
        ...
        <div class="table-responsive">
            <table class="table table-bordered align-middle" id="detailTableJual">
                ...
                <tbody>
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $existingDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <select name="produk_id[]" class="form-select produk-select" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->id); ?>" 
                                        ...
                                        <?php if($p->id == $detail['produk_id']): ?> selected <?php endif; ?>
                                    ><?php echo e($p->nama_produk ?? $p->nama); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                            <small class="text-muted stok-info"></small>
                        </td>
                        <td><input type="number" step="0.0001" min="0.0001" name="jumlah[]" class="form-control jumlah" value="<?php echo e($detail['jumlah']); ?>" required></td>
                        <td><input type="text" name="harga_satuan[]" class="form-control harga" value="<?php echo e(number_format($detail['harga_satuan'], 0, ',', '.')); ?>" readonly required></td>
                        <td><input type="number" step="0.01" min="0" max="100" name="diskon_persen[]" class="form-control diskon" value="<?php echo e($detail['diskon_persen']); ?>"></td>
                        <td><input type="text" name="biaya_angkut[]" class="form-control biaya_angkut" value="<?php echo e(number_format($detail['biaya_angkut'], 0, ',', '.')); ?>"></td>
                        <td><button type="button" class="btn btn-danger btn-sm removeRow">-</button></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($existingDetails) === 0): ?>
                    <tr>
                        <td>
                            <select name="produk_id[]" class="form-select produk-select" required>
                                <option value="">-- Pilih Produk --</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->id); ?>" 
                                            data-price="<?php echo e($p->harga_jual ?? 0); ?>"
                                            data-stok="<?php echo e($p->stok_tersedia ?? 0); ?>">
                                    ><?php echo e($p->nama_produk ?? $p->nama); ?> (Stok: <?php echo e(number_format($p->stok_tersedia ?? 0, 0, ',', '.')); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                            <small class="text-muted stok-info"></small>
                        </td>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="total_penjualan" class="form-control text-end fw-bold bg-light" value="<?php echo e(number_format($penjualan->total - ($penjualan->total_ppn ?? 0), 0, ',', '.')); ?>" readonly id="total_penjualan">
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" step="0.01" min="0" max="100" name="ppn_persen" class="form-control text-end" value="<?php echo e($penjualan->ppn_persen ?? 11); ?>" id="ppn_persen">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="text" name="total_ppn" class="form-control text-end" value="<?php echo e(number_format($penjualan->total_ppn ?? 0, 0, ',', '.')); ?>" readonly id="total_ppn">
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="text" name="total" class="form-control text-end fw-bold bg-light" value="<?php echo e(number_format($penjualan->total, 0, ',', '.')); ?>" readonly id="total_final">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    // Init first row
    <?php if(count($existingDetails) > 0): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\UMKM_COE\resources\views/transaksi/penjualan/edit.blade.php ENDPATH**/ ?>