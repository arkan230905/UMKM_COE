                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="tarif_btkl" class="form-control <?php $__errorArgs = ['tarif_btkl'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('tarif_btkl', 0)); ?>" min="0" step="100" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="jam" <?php echo e(old('satuan_btkl') == 'jam' ? 'selected' : ''); ?>>Jam</option>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('kapasitas_per_jam', 50)); ?>" min="1" step="1" placeholder="50" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\UMKM_COE\resources\views/master-data/proses-produksi/create.blade.php ENDPATH**/ ?>