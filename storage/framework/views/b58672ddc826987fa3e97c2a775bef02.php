...
<div class="container">
    ...
    <form action="<?php echo e(route('profil-admin.update')); ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="username" id="username" class="form-control" value="<?php echo e($user->username); ?>">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampppp\htdocs\UMKM_COE\resources\views/profile/edit.blade.php ENDPATH**/ ?>