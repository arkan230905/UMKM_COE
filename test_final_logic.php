...
echo "=== Test Final Logic - Saldo Awal Hanya di Tanggal Pertama ===\n";
...
foreach ($movementsByDate as $dateStr => $dayMovements) {
    ...
    // For first transaction, show initial stock
    // For subsequent transactions, no opening stock
...
echo "Saldo awal hanya di tanggal pertama:\n\n";
