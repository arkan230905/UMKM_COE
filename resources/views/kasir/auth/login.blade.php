...
<head>
    ...
    <style>
        ...
        .login-card .card-header { background: #28a745; color: #fff; border-radius: 15px 15px 0 0 !important; padding: 25px; text-align: center; }
        ...
        .btn-login { background: #28a745; border: none; border-radius: 8px; padding: 12px; font-size: 16px; font-weight: 600; }
        ...
        <div class="login-card">
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-cash-register d-block"></i>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('kasir.login.post') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="Masukkan email pegawai kasir" value="{{ old('email') }}" required autofocus>
                    ...
                    <div class="text-center">
                        <small class="text-muted">Hanya pegawai dengan jabatan Kasir yang bisa login</small>
                    </div>
                </div>
            </div>
        </div>
