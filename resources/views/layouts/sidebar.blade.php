<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item"><a href="{{ url('/master-data/aset') }}" class="nav-link"><i class="bi bi-box2-heart me-2"></i> Aset</a></li>
        <li class="nav-item"><a href="{{ route('master-data.satuan.index') }}" class="nav-link"><i class="bi bi-upc-scan me-2"></i> Satuan</a></li>
        <li class="nav-item"><a href="{{ route('master-data.jabatan.index') }}" class="nav-link"><i class="bi bi-briefcase me-2"></i> Jabatan</a></li>
        ...
        <li class="nav-item"><a href="{{ route('master-data.bop-budget.index') }}" class="nav-link"><i class="bi bi-calculator me-2"></i> BOP</a></li>
