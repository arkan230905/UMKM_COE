    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('master-data.btkl.store') }}" method="POST" id="createBtklForm">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_proses" class="form-control @error('nama_proses') is-invalid @enderror" 
                                   value="{{ old('nama_proses') }}" placeholder="Contoh: Pengisian Cup Jasuke" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" id="tarifBTKLDisplay" class="form-control" readonly>
                                <input type="hidden" name="tarif_per_produk" id="tarifPerProduk" value="{{ old('tarif_per_produk', 0) }}">
                                <input type="hidden" name="jumlah_pegawai" id="jumlahPegawaiHidden" value="{{ old('jumlah_pegawai', 0) }}">
                            </div>
                ...
                {{-- Kolom Satuan dihapus dari sini --}}
