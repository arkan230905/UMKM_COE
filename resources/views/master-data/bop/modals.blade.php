                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            <div class="card mb-3" style="border-left: 4px solid #198754;">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm" id="editKomponenBahanTable">
                                            <thead class="table-light">
                                                <tr>
                                                    <th style="width: 25%;">Bahan Pendukung</th>
                                                    <th style="width: 15%;">Rp / produk</th>
                                            ...
                                            <tbody id="editKomponenBahanRows">
                                                <!-- Bahan Pendukung rows will be loaded here -->
                                            </tbody>
                                        </table>
                                    </div>
                                    <button type="button" class="btn btn-sm btn-success mt-2" onclick="addEditBahanRow()">
                                        <i class="fas fa-plus"></i> Tambah Bahan Pendukung
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="card" style="border-left: 4px solid #0d6efd;">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm" id="editKomponenLainTable">
                                            <thead class="table-light">
                                                <tr>
                                                    <th style="width: 25%;">Komponen</th>
                                                    <th style="width: 15%;">Rp / produk</th>
                                            ...
                                            <tbody id="editKomponenLainRows">
                                                <!-- Lainnya rows will be loaded here -->
                                            </tbody>
                                        </table>
                                    </div>
                                    <button type="button" class="btn btn-sm btn-primary mt-2" onclick="addEditLainRow()">
                                        <i class="fas fa-plus"></i> Tambah Komponen Lain
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="card-body bg-warning bg-opacity-10">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text fw-bold">Rp</span>
                                                <input type="text" id="editTotalBopPerProduk" name="total_bop_per_produk" class="form-control form-control-lg text-end fw-bold" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
