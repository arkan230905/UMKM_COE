        ...
        <div class="card-body">
            <form action="{{ route('master-data.bahan-baku.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_bahan" class="form-control @error('nama_bahan') is-invalid @enderror" 
                                   value="{{ old('nama_bahan') }}" placeholder="Contoh: Tepung Terigu, Gula Pasir" required>
                            @error('nama_bahan')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="3" placeholder="Deskripsi bahan baku (opsional)">{{ old('deskripsi') }}</textarea>
                </div>
