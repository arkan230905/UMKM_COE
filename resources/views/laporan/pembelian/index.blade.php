        ...
        <div class="col-md-4">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    ...
                    <h3 class="mb-0">{{ $pembelian->total() }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-success text-white">
                <div class="card-body">
                    ...
                    <h3 class="mb-0">Rp {{ number_format($pembelian->sum('total'), 0, ',', '.') }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-info text-white">
                <div class="card-body">
                    ...
                    <h3 class="mb-0">Rp {{ $pembelian->count() > 0 ? number_format($pembelian->sum('total') / $pembelian->count(), 0, ',', '.') : 0 }}</h3>
                </div>
            </div>
        </div>
    </div>
