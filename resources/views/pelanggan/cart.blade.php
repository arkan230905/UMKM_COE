...
<div class="container py-4">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h3 class="mb-0 text-dark" style="font-weight: 700;">Keranjang Belanja</h3>
            <p class="mb-0 text-muted" style="font-size: 0.9rem;">Review produk pilihanmu sebelum checkout</p>
        </div>
    </div>
