    ...
    <div class="container py-4">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                ...
                <!-- Search -->
                <form action="{{ route('pelanggan.dashboard') }}" method="GET" class="umkm-search mt-3">
            ...
            <div class="col-lg-5">
                <div class="umkm-slider-box">
                    ...
                    <div class="umkm-slider" id="umkmSlider">
                        @foreach($bestSellers as $index => $b)
                        <div class="umkm-slide {{ $index == 0 ? 'active' : '' }}">
                            ...
                            <div class="slide-info">
                                <h4>{{ $b->nama_produk }}</h4>
                                <p class="slide-price">Rp {{ number_format($b->harga_jual,0,',','.') }}</p>
                                <p class="slide-meta">
                                    ⭐ {{ number_format($b->avg_rating, 1) }} • {{ $b->total_terjual ?? 0 }} terjual
                                </p>
                            </div>
