...
<div class="container-fluid">
    ...
    <form id="bomForm" method="POST" action="{{ route('bom.store') }}">
        @csrf
        <div class="bom-form">
            <div class="row mb-4">
                <div class="col-md-12">
            ...
            <div class="row g-3" id="bahanBakuRows">
                <!-- Bahan Baku rows will be added here -->
            </div>

            <div class="row g-3" id="bahanPendukungRows">
                <!-- Bahan Pendukung rows will be added here -->
            </div>

            <div class="row">
                <div class="col-md-12">
                    <button type="button" class="btn btn-icon btn-add" onclick="addBahanBakuRow()">
                        <i class="fas fa-plus me-1"></i>Tambah Bahan Baku
                    </button>
                    <button type="button" class="btn btn-icon btn-add" onclick="addBahanPendukungRow()">
            ...
            <div class="total-section">
                <div class="row">
                    <div class="col-md-6">
                        <h3>Total BOM</h3>
                        <div class="total-amount">Rp <span id="totalBom">0</span></div>
                    </div>
                    <div class="col-md-6">
                        <h3>Total Item</h3>
                        <div class="total-amount"><span id="totalItems">0</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="action-buttons">
                <button type="submit" class="btn btn-icon btn-save">
                    <i class="fas fa-save me-1"></i>Simpan BOM
                </button>
...
function updateTotal() {
    ...
    // Calculate total from bahan baku rows
    const bahanBakuRows = document.querySelectorAll('#bahanBakuRows .material-row');
    ...
    // Calculate total from bahan pendukung rows
    const bahanPendukungRows = document.querySelectorAll('#bahanPendukungRows .material-row');
