                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    ...
                                    <strong>Pegawai:</strong> {{ $pegawai->nama }} ({{ $pegawai->kode_pegawai }})
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="pegawaiInfo" class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div id="pegawaiDetails">
                                            ...
                                            <p><strong>Kode:</strong> {{ $pegawai->kode_pegawai }}</p>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('transaksi.presensi.verifikasi-wajah.create') }}" class="btn btn-secondary">
                    ...
                    @else
                        ...
                        <div class="row">
                            <div class="col-md-8 mx-auto">
                                ...
                                <form method="POST" action="{{ route('transaksi.presensi.verifikasi-wajah.step1') }}">
                                    @csrf
                                    <div class="mb-3">
                                        ...
                                        <select name="kode_pegawai" id="kode_pegawai" class="form-select" required>
                                            ...
                                            @foreach($pegawais as $p)
                                                <option value="{{ $p->kode_pegawai }}">
                                                    {{ $p->nama }} ({{ $p->kode_pegawai }})
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
...
let stream = null;
let model = null;
let currentPegawai = '{{ $pegawai->kode_pegawai }}';
