...
<head>
    ...
    <style>
        ...
        *::-webkit-scrollbar {
        ...
        /* Remove autofill/autocomplete icons from input fields */
        ...
        /* Remove any validation icons from form-control */
        .form-control {
            background-image: none !important;
        }

        /* Remove webkit autofill decoration */
                ...
                <div id="login-fields" style="display: none;">
                    ...
                    <div id="password_field" class="mb-3" style="display: none;">
                        ...
                        <div style="position: relative;">
                            <input id="password" type="password" name="password" class="form-control" placeholder="Masukkan password" style="padding-right: 2.5rem !important;">
