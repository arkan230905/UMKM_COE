                ...
                <div id="login-fields" style="display: none;">
                    ...
                    <div id="password_field" class="mb-3" style="display: none;">
                        ...
                        <div style="position: relative;">
                            <input id="password" type="password" name="password" class="form-control" placeholder="Masukkan password" style="padding-right: 40px; width: 100%; height: 35px; line-height: 35px; box-sizing: border-box;">
                            <button type="button" id="togglePassword" style="
                                ...
                                border-radius: 4px;
                                margin: 0;
                            " onmouseover="this.style.backgroundColor='rgba(139, 111, 71, 0.1)'; this.style.color='#6d5637'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#8b6f47'">
                                <svg id="eyeIcon" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display: block; flex-shrink: 0;">
