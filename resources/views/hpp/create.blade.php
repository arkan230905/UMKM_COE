            ...
            <div class="col-md-12 mb-4">
                <div class="card shadow-sm">
                    <div class="card-header" style="background-color: #ffc107; color: black;">
                        <h6 class="mb-0">
                            <i class="fas fa-cogs me-2"></i>Pilih Biaya Overhead Produksi (BOP)
                        </h6>
                    </div>
                    <div class="card-body">
                        @if($bops->count() > 0)
                                        ...
                                        <div class="card border">
                                            <div class="card-body">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="bop_{{ $bop->id }}">
                                                        <strong>{{ $bop->nama_akun }}</strong>
                                                        <br>
                                                        <small class="text-muted">
                                                            Kode: {{ $bop->kode_akun }} | 
                                                            Nominal: Rp {{ number_format($bop->nominal ?? 0, 0, ',', '.') }}
                                                        </small>
                                                    </label>
                                                </div>
                                            </div>
                        ...
                        @else
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle me-2"></i>
                                Belum ada data BOP. <a href="{{ route('master-data.bop.create') }}" class="alert-link">Tambah BOP terlebih dahulu</a>
                            </div>
                        @endif
                    </div>
                </div>
