...
// First check penjualan table structure
echo "=== PENJUALAN TABLE STRUCTURE ===\n";
$penjualanColumns = \Illuminate\Support\Facades\Schema::getColumnListing('penjualans');
echo "Columns: " . implode(', ', $penjualanColumns) . "\n\n";

// Get all penjualan transactions
$penjualans = \App\Models\Penjualan::orderBy('id')->get(['id', 'tanggal', 'total_harga']);
