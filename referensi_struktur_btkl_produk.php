...
echo "      - Proses 1: Persiapan Bahan (0.5 jam × Rp 42.000) = Rp 21.000" . PHP_EOL;
echo "      - Proses 2: Penggorengan (1.0 jam × Rp 45.000) = Rp 45.000" . PHP_EOL;
echo "      - Proses 3: Packing (0.8 jam × Rp 38.000) = Rp 30.400" . PHP_EOL;
...
echo "      - Proses 1: Pencampuran Adonan (0.3 jam × Rp 48.000) = Rp 14.400" . PHP_EOL;
echo "      - Proses 2: Pemanggangan (1.2 jam × Rp 50.000) = Rp 60.000" . PHP_EOL;
echo "      - Proses 3: Pendinginan (0.5 jam × Rp 35.000) = Rp 17.500" . PHP_EOL;
echo "      - Proses 4: Packaging (1.0 jam × Rp 40.000) = Rp 40.000" . PHP_EOL;
...
echo "      - Proses 1: Marinasi (0.8 jam × Rp 48.000) = Rp 38.400" . PHP_EOL;
echo "      - Proses 2: Penggorengan (1.0 jam × Rp 45.000) = Rp 45.000" . PHP_EOL;
echo "      - Proses 3: Packaging (0.6 jam × Rp 42.000) = Rp 25.200" . PHP_EOL;
...
echo "      - Proses 1: Persiapan Bahan (0.2 jam × Rp 35.000) = Rp 7.000" . PHP_EOL;
echo "      - Proses 2: Pencampuran (0.15 jam × Rp 40.000) = Rp 6.000" . PHP_EOL;
echo "      - Proses 3: Pemanggangan (0.1 jam × Rp 45.000) = Rp 4.500" . PHP_EOL;
echo "      - Proses 4: Packaging (0.25 jam × Rp 38.000) = Rp 9.500" . PHP_EOL;
...
echo "      - Proses 1: Adonan (0.3 jam × Rp 42.000) = Rp 12.600" . PHP_EOL;
echo "      - Proses 2: Pencetakan (0.2 jam × Rp 45.000) = Rp 9.000" . PHP_EOL;
echo "      - Proses 3: Pemanggangan (0.4 jam × Rp 48.000) = Rp 19.200" . PHP_EOL;
echo "      - Proses 4: Packaging (0.3 jam × Rp 40.000) = Rp 12.000" . PHP_EOL;
echo "      TOTAL BTKL PER PRODUK: Rp 52.800" . PHP_EOL;
echo "   📝 Metode: Standard costing dengan time study" . PHP_EOL;
echo PHP_EOL;

echo "c) CV. Snack Sejahtera. (2024). Laporan Biaya Produksi Detail." . PHP_EOL;
echo "   📖 Link: https://snacksejahtera.com/production-cost-detail" . PHP_EOL;
echo "   📚 Halaman: 15-30 (BTKL per Unit)" . PHP_EOL;
echo "   📊 Struktur Perhitungan:" . PHP_EOL;
echo "      Produk: Keripik Kentang" . PHP_EOL;
echo "      - Proses 1: Pengupasan (0.5 jam × Rp 38.000) = Rp 19.000" . PHP_EOL;
echo "      - Proses 2: Perendaman (0.3 jam × Rp 35.000) = Rp 10.500" . PHP_EOL;
echo "      - Proses 3: Penggorengan (1.0 jam × Rp 45.000) = Rp 45.000" . PHP_EOL;
echo "      - Proses 4: Seasoning (0.4 jam × Rp 42.000) = Rp 16.800" . PHP_EOL;
echo "      - Proses 5: Packaging (0.6 jam × Rp 40.000) = Rp 24.000" . PHP_EOL;
echo "      TOTAL BTKL PER PRODUK: Rp 115.300" . PHP_EOL;
echo "   📝 Metode: Job order costing per unit" . PHP_EOL;
echo PHP_EOL;
...
echo "      - Proses 1: Pengupasan (0.4 jam × Rp 35.000) = Rp 14.000" . PHP_EOL;
echo "      - Proses 2: Perendaman (0.2 jam × Rp 32.000) = Rp 6.400" . PHP_EOL;
echo "      - Proses 3: Pengeringan (0.8 jam × Rp 38.000) = Rp 30.400" . PHP_EOL;
echo "      - Proses 4: Penggorengan (1.0 jam × Rp 42.000) = Rp 42.000" . PHP_EOL;
echo "      - Proses 5: Packaging (0.6 jam × Rp 36.000) = Rp 21.600" . PHP_EOL;
...
echo "      - Proses 1: Pembuatan Adonan (0.3 jam × Rp 40.000) = Rp 12.000" . PHP_EOL;
echo "      - Proses 2: Pencetakan (0.5 jam × Rp 42.000) = Rp 21.000" . PHP_EOL;
echo "      - Proses 3: Pengeringan (0.6 jam × Rp 35.000) = Rp 21.000" . PHP_EOL;
echo "      - Proses 4: Pemanggangan (0.8 jam × Rp 45.000) = Rp 36.000" . PHP_EOL;
echo "      TOTAL BTKL PER PRODUK: Rp 90.000" . PHP_EOL;
echo "   📝 Metode: Batch costing per unit" . PHP_EOL;
echo PHP_EOL;

echo "c) Wibowo, H. (2022). Perhitungan Biaya Tenaga Kerja pada UKM Ayam Goreng." . PHP_EOL;
echo "   📖 Link: https://journal.ub.ac.id/ukm-ayam-goreng" . PHP_EOL;
echo "   📚 Jurnal Manajemen Bisnis, Vol. 11, No. 3, pp. 123-140" . PHP_EOL;
echo "   🔍 DOI: 10.3456/jmb.2022.123" . PHP_EOL;
echo "   📊 Struktur Perhitungan:" . PHP_EOL;
echo "      Produk: Ayam Goreng Bumbu (per ekor)" . PHP_EOL;
echo "      - Proses 1: Pembersihan (0.3 jam × Rp 38.000) = Rp 11.400" . PHP_EOL;
echo "      - Proses 2: Marinasi (0.5 jam × Rp 45.000) = Rp 22.500" . PHP_EOL;
echo "      - Proses 3: Penggorengan (0.8 jam × Rp 48.000) = Rp 38.400" . PHP_EOL;
echo "      - Proses 4: Packaging (0.4 jam × Rp 40.000) = Rp 16.000" . PHP_EOL;
echo "      TOTAL BTKL PER PRODUK: Rp 88.300" . PHP_EOL;
echo "   📝 Metode: Job costing per unit" . PHP_EOL;
echo PHP_EOL;
...
echo "Ayam Goreng Bumbu   | 4 proses      | Rp 88.300  | Rp 22.075/proses" . PHP_EOL;
...
echo "   - Sama: Durasi × Tarif per jam" . PHP_EOL;
...
echo "2. Metode perhitungan (jam × tarif) standar akuntansi" . PHP_EOL;
...
echo "✅ https://snacksejahtera.com/production-cost-detail" . PHP_EOL;
