...
class CoaJagungSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $coaData = [
            ...
            [
                'user_id' => $userId,
                'parent_id' => 1, // Parent: 117 - Persediaan Barang Dalam Proses
                'kode_akun' => '1171',
            ...
            [
                'user_id' => $userId,
                'parent_id' => 1, // Parent: 111 - Kas Bank
                'kode_akun' => '1111',
                'nama_akun' => 'Bank BCA',
                'tipe_akun' => 'Aset',
                'kategori_akun' => '-',
