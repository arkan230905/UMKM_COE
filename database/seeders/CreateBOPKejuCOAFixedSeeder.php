...
class CreateBOPKejuCOAFixedSeeder extends Seeder
{
    /**
    ...
    {
        Log::info('Starting CreateBOPKejuCOAFixedSeeder');
        ...
        $kejuCOA = [
            ...
            'tipe_akun' => 'Beban',
            'saldo_normal' => 'kredit',
            'kategori_akun' => 'Beban BOP', // Add missing field
            'created_at' => now(),
            'updated_at' => now(),
        ];
        ...
        DB::table('jurnal_umum')->insert([
            ...
            [
                ...
                'keterangan' => 'Alokasi BOP untuk Produksi Jasuke',
                'debit' => 0,
                'kredit' => 120000, // Keju (with correct separate COA!)
                'referensi' => $produksiId,
                'tipe_referensi' => 'produksi_bop',
                'created_by' => $user_id,
                'created_at' => now(),
