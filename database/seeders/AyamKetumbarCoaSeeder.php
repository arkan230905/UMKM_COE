...
class AyamKetumbarCoaSeeder extends Seeder
{
    /**
     * COA Seeder untuk Ayam Ketumbar
     * Dipanggil manual dengan: php artisan db:seed --class=AyamKetumbarCoaSeeder
     * Atau secara programatik: $seeder->run($userId);
     */
